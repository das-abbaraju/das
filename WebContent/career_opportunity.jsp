...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0','width','364','height','72','src','flash/NAV_HOME','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','flash/NAV_HOME' ); //end AC code
                ...
                <tr>
                  <td height="146"><img src="images/photo_career.jpg" width="510" height="146">
            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td valign="top" bgcolor="#FFFFFF"><table border="0" align="center" cellpadding="0" cellspacing="0">
					  					  					  <tr>
                      <td  bgcolor="#F8F8F8" class="blueHome2"><strong class="articleTitle">Interested in joining the PICS team?</strong><br>
                        <p>PICS is an exciting company that specializes in contractor management for companies all across the U.S.  Our employees are the core of our success. The PICS team is committed to the safety and risk reduction of everyone we work with. PICS welcomes innovative minded individuals who are committed to working in a team environment. PICS has leaders with years of experience in occupational safety as well as business management which is anchored by our strong relationships with our customers.</p>
                        <p>PICS is seeking smart, talented, creative and motivated individuals to join our team. Our current needs are safety professionals as well as customer service staff. We encourage you to learn more about PICS and contact us. </p>
                        <p>For more information about a career with PICS please call <strong>949-387-1940</strong> ext <strong>704</strong>.<br>
                          Please email your resume to <a href="mailto: careers@picsauditing.com">careers@picsauditing.com</a></p></td>
                    </tr>
                </table></td>
                <td bgcolor="#CCCCCC"><img src="images/spacer.gif" alt="spacer" width="1" height="1"></td>
              </tr>
