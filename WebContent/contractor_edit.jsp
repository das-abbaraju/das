	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="1">
			...
			<tr>
				...
				<td valign="top" class="redMain"><input name="email"
					type="text" class="forms" size="30" value="<%=aBean.email%>">
				<br>
			...
			<tr>
				...
				<td class="redMain"><input name="web_URL" type="text"
					class="forms" size="26" value="<%=aBean.web_URL%>"> <br>
			...
			<tr>
				...
				<td><%=aBean.getIndustrySelect("industry", "forms", aBean.industry)%>
				</td>
			</tr>
			<tr>
...
-->
			...
			<tr>
				...
				<td class="blueMain"><input name="logo_file" type="FILE"
					class="forms" size="15"> (.gif/jpg file)<br>
				<span class="redMain">Please limit the image size to 240 x
				240 <br>
				pixels for optimal displaying</span></td>
			</tr>
			<tr>
				<td class="blueMain" align="right">Co. Brochure</td>
				<td class="blueMain"><input name="brochure_file" type="FILE"
					class="forms" size="15"> (.pdf file)</td>
			</tr>
			<tr>
