	...
	<tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
			  ...
			  <tr>
                <td></td><td><span align="center" class="blueMain">You have <strong><%=sBean.getNumResults()%></strong> contractors to audit | &nbsp;</span><%=sBean.getLinks()%>
			    </td>
              </tr>
             <tr>
			    <td colspan="2">&nbsp;</td>
...
sBean.closeSearch();	
%> 
                       <br><center><input name="Submit" type="submit" class="buttons" value="Submit" ><br><br>
