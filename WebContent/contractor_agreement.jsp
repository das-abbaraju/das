...
from or related in any way to the PICS audit and/or the use of the PICS website.</p>
<p>While PICS will endeavor to accurately record the information received from you into your company's account appearing
...
the information contained in the PICS website.</p>
<p>Listing on the PICS website does not guarantee acceptance of work from any client. It is understood these audits are for
...
violation of this user agreement will result in your account being either temporarily or permanently deactivated.</p><br/>

<b><u>PRIVACY POLICY</u></b>
<p>PICS' privacy policy can be accessed here as well as from the payment option page
<a href="http://picsorganizer.com/privacy_policy.jsp">(http://picsorganizer.com/privacy_policy.jsp)</a>.</p><br/>
...
entered through the PICS website.</p>
<p>Sensitive data is defined as the following: your company's Prequalification Form (PQF), specific Insurance information,
...
data, but is password protected and shared only with PICS consortium operator members.</p>
<p>In an effort to help you gain more work with PICS consortium operator members, authorized users can add your
...
<a href="http://picsorganizer.com/refund_policy.jsp">(http://picsorganizer.com/refund_policy.jsp)</a></p>
