...
<p>Partial refunds are offered if contractor decides within 7 days of registration that they registered in error and contacts PICS within 7 days.  Partial refund is defined as a refund of the membership fee.  The Activation fee (i.e. the $199 registration fee) will not be refunded for any reason.  The annual membership fee (starting at $99 through $3,999) can be refunded if and only if no audit has been commenced by PICS and Contractor has contacted PICS within 7 days of registration.  Audits that have commenced that prevent the refund are the following:  Annual Update Audit, PQF Verification, InsureGUARD&trade;, Manual Audit, Implementation Audit, or any other audit requested by operator.</p>
