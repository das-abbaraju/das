            <table border="0" align="center" cellpadding="2" cellspacing="0">
              <tr> 
                ...
                <td><input name="zip" type="text" class="forms" value="<%=sBean.selected_zip%>" size="5" onFocus="clearText(this)"></td<!--			<td><%=sBean.getSearchZipSelect("zip","forms",sBean.selected_zip)%></td>
