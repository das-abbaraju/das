...
<%		if(pBean.oBean.seesAllContractors() && pBean.getPermissions().hasPermission(com.picsauditing.access.OpPerms.SearchContractors)){%>
      <a class=blueMain href=contractorsSearch.jsp>Search For New Contractors</a> | 
<%		}//if
		if (pBean.getPermissions().hasPermission(com.picsauditing.access.OpPerms.EditUsers)){%>
