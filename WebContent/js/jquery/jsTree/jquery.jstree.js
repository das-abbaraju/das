	...
	$.vakata.css = {
		...
		add_sheet : function(opts) {
		    ...
		    function checkNumberOfStylesheets() {
		        return (document.styleSheets.length <= 30) ? true : false;
		    }

		    function addStylestoStyleTag() {
		        var jstree_style_tag = document.getElementById('jstreestyles'),
		        textnode = document.createTextNode(opts.str);
