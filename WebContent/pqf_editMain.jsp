...
<table border="0" cellspacing="0" cellpadding="1" class="blueMain">
 ...
 %> </a></td>
	...
	<tr align="center">
			...
			<%
				pcBean.setListWithData("number", action.getAudit());
					...
					while (pcBean.isNextRecord()) {
						if (!com.picsauditing.PICS.pqf.Constants.PQF_TYPE.equals(auditType) || pBean.isAdmin()
								|| "Yes".equals(pcBean.applies)) {
							catCount++;
			%>
		...
		<%
			if ((com.picsauditing.PICS.pqf.Constants.DESKTOP_TYPE.equals(auditType)
						|| com.picsauditing.PICS.pqf.Constants.DA_TYPE.equals(auditType) || com.picsauditing.PICS.pqf.Constants.OFFICE_TYPE
						.equals(auditType))
						&& pBean.isAdmin()) {
		%>
		<form name="form1" method="post" action="pqf_editMain.jsp"><input
