...
<s:else>
	<div id="trade-view-single">
		...
		<p><s:text name="TradeTaxonomy.NumberOfContractors"><s:param><s:property value="trade.contractorCount"/></s:param></s:text></p>
		<p><a href="<s:url action="ContractorList"><s:param name="filter.trade" value="%{trade.id}"/></s:url>"><s:text name="TradeTaxonomy.ViewContractors"/></a></p>
	</div>
</s:else>