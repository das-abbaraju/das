...
<div id="trade-nav">
	...
	<div id="search-tab">
		...
		<s:radio cssClass="searchType" name="searchType" list="#{'list':getText('ContractorTrades.button.List'), 'tree':getText('ContractorTrades.button.Tree')}" value="'list'" theme="simple" />
