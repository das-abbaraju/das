...
<html>
	...
	<body>
		...
		<s:form cssClass="schedule-audit-form schedule-audit-address-form" onsubmit="return submitForm();">
			...
			<fieldset class="form">
				...
				<ol>
					<li class="calculatedAddress">
						...
						<s:textfield id="conAudit_address" name="conAudit.address" size="50" value="%{conAudit.contractorAccount.address}"/> <s:text name="ScheduleAudit.message.NoPOBoxes" />
					</li>
					<li>
						<label><s:text name="global.Address" /> 2:</label>
						<s:textfield id="conAudit_address2" name="conAudit.address2" value="%{conAudit.contractorAccount.address2}"/> <s:text name="ScheduleAudit.message.SuiteApartment" />
					</li>
					<li class="calculatedAddress">
					...
					<li id="unverifiedLI" style="display: none;">
						<s:checkbox id="unverifiedCheckbox" onchange="$('#submitButton').toggle()" name="unverifiedCheckbox"></s:checkbox>
