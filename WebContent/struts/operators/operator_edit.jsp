...
<s:hidden name="operatorCountrySubdivision" value="%{operator.countrySubdivision.isoCode}"
          id="operatorCountrySubdivision"/>
...
<fieldset class="form">
    ...
    <ol>
        <li>
            <s:checkbox id="rememberMeTimeCheckbox" name="operator.rememberMeTimeEnabled" theme="formhelp"
...
<fieldset class="form">
    ...
    <ol>
        ...
        <li>
            ...
            <input id="number_pending_not_approved" type="hidden" name="number_pending_not_approved"
                   value="${pendingAndNotApprovedRelationshipCount}"/>
        ...
        <li>
            ...
            <pics:fieldhelp title="Health &amp; Safety Organization">
                <p>The source of statistics that should be used to evaluate contractors. Operators can collect more than
                    one, but only one can be used to evaluate stats.</p>
            </pics:fieldhelp>
        </li>
        <li>
        ...
        <li id="act_li">
            ...
            <s:if test="!operator.hasDiscount && operator.inheritedDiscountPercentOperator">
                ...
                &nbsp;&nbsp;(Discount Percentage inherited from <a
                    href="FacilitiesEdit.action?operator=${operator.inheritedDiscountPercentOperator.id}">${operator.inheritedDiscountPercentOperator.name}</a>).
            </s:if>
            <s:else>
