				...
				<table class="report">
					...
					<tbody>
						<s:iterator value="certData.keySet()" id="key">
							<s:iterator value="certData.get(#key)" id="data" status="stat">
								<tr>
									<s:if test="#stat.first">
										<td rowspan="<s:property value="certData.get(#key).size" />">
											<s:property value="#key.auditName" /></td>
									</s:if>
									<td><s:property value="#data.question.category.name" /></td>
									<td class="center">
