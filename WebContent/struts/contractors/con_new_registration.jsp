...
<s:form id="saveContractorForm">
	...
	<fieldset class="form">
		<h2 class="formLegend"><s:text name="RequestNewContractor.header.CompanyInformation" /></h2>
		<ol>
			...
			<li><s:textfield cssClass="checkReq" name="newContractor.phone" size="20" theme="formhelp" />
			...
			<li><s:textfield cssClass="checkReq" name="newContractor.email" size="30" id="email" theme="formhelp" />
				<s:if test="newContractor.id > 0 && newContractor.email.length() > 0 && !permissions.operatorCorporate">
					...
					<table id="email_preview">
						<tr>
							...
							<td>
								<s:if test="formsViewable && attachment == null && forms.size() > 0"><div id="attachment"></div></s:if>
							</td>
						</tr>
						<tr>
							<td>
			...
			<s:if test="assignedCSR != null">
				<li><label><s:text name="RequestNewContractor.label.AssignedCSR" />:</label>
		...
		<ol>
			<li><label for="newContractorCountry"><s:text name="Country" />:</label>
			...
			<li id="state_li"></li>
			<li><s:textfield name="newContractor.city" size="20" id="city" cssClass="show-address" theme="formhelp" /></li>
			<li class="address-zip"><s:textfield name="newContractor.address" size="35" id="address" theme="formhelp" /></li>
			<li class="address-zip"><s:textfield name="newContractor.zip" size="7" id="zip" theme="formhelp" /></li>
		</ol>
	</fieldset>
	<fieldset class="form">
		<h2 class="formLegend"><s:text name="RequestNewContractor.header.RequestSummary" /></h2>
		<ol>
			...
			<s:if test="newContractor.requestedByUser != null && newContractor.id > 0">
				<li><label><s:text name="RequestNewContractor.label.AddToWatchlist" />:</label>
					<s:checkbox name="newContractor.watch" />
					<div class="fieldhelp">
					<h3><s:text name="RequestNewContractor.label.AddToWatchlist" /></h3>
						<p>
			...
			<li>
				<s:textfield id="regDate" name="newContractor.deadline" cssClass="datepicker" size="10" 
					onchange="checkDate(this)" theme="formhelp" />
			</li>
			<li><s:textarea id="reasonForRegistration" name="newContractor.reasonForRegistration" theme="formhelp" /></li>
		</ol>
	</fieldset>
	<fieldset class="form">
		...
		<ol>
			<s:if test="newContractor.id > 0">
				<li><label><s:text name="RequestNewContractor.label.LastContactedBy" />:</label>
					<s:property value="newContractor.lastContactedBy.name" /><br />
				</li>
				<li><label><s:text name="RequestNewContractor.label.DateContacted" />:</label>
					<s:date name="newContractor.lastContactDate" /><br />
				</li>
			</s:if>
			<s:if test="newContractor.id > 0">
				<s:if test="permissions.admin">
					<li><label><s:text name="RequestNewContractor.label.FollowUp" />:</label>
				...
				<li><label><s:text name="RequestNewContractor.label.TimesContacted" />:</label>
					<s:property value="newContractor.contactCount" />
				</li>
				<li><label><s:text name="RequestNewContractor.label.MatchesFound" />:</label>
				...
				<li><label><s:text name="RequestNewContractor.label.PICSContractor" />:</label>
				<s:if test="permissions.admin">
			...
			<p><s:text name="RequestNewContractor.help.Notes" /></p>
			</div>
			</li>
			<li>(<s:text name="RequestNewContractor.message.MaximumCharacters" />)<br />
			<div id="notesDiv">
			...
			<s:if test="newContractor.id == 0">
				<li>
				<div class="info"><s:text name="RequestNewContractor.message.AutoEmailOnSave" /></div>
				</li>
			</s:if>
		</ol>
	</fieldset>
