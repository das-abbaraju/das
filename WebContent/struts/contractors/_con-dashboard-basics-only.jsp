...
<div class="panel_placeholder">
	<div class="panel">
		...
		<div class="panel_content">
			...
			<s:if test="contractor.auditor != null">			
				<p>
					<s:text name="global.CSR" />:
					<strong>
						${contractor.auditor.name} / ${contractor.auditor.phone}
                        <span id="CSRNote">(<s:text name="ContractorView.ContractorDashboard.CSRCallNote" />)</span>
						/
					</strong>
					<s:text name="ProfileEdit.u.fax" />: ${contractor.auditor.fax}
					/ 
					<a href="mailto:${contractor.auditor.email}" class="email">
						${contractor.auditor.email}
					</a>
				</p>
			</s:if>
