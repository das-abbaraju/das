...
function saveClosingAuditor(auditorId) {
    var data = {
        'contractorAudit': $('#auditID').val(),
        'closingAuditor.id': auditorId
    };
    $('#auditorAssignmentDate').load('AuditAssignmentUpdateAjax!saveClosingAuditor.action', data, function(text, status) {
            }
    );
}
$(function() {
