...
<s:if test="currentOperators.size() == 0">
    ...
    <a href="http://help.picsorganizer.com/display/contractors/Facilities+List+Maintenance" class="help" target="_BLANK"><s:text name="ContractorFacilities.ClickForHelp" /></a>
</div>
</s:if>
<s:else>
    <label><s:text name="%{scope}.ContractorFacilities.NumberOfLinkedFacilities" />:</label>
    <s:property value="currentOperators.size()" />
    <br />
        ...
        <s:if test="contractor.hasUpgrade"> 
            <table>
                ...
                <s:iterator value="contractor.fees.keySet()" var="feeClass">
                    <s:if test="!contractor.fees.get(#feeClass).newLevel.free && #feeClass.membership">
                        <tr>
                            ...
                            <td class="right">
                                <s:property value="contractor.country.currency.symbol" /><s:property value="contractor.fees.get(#feeClass).newAmount" />
                            </td>
                            <td>
                ...
                <tr>
                    ...
                    <td class="right">
                        <s:property value="contractor.country.currency.symbol" /><s:property value="contractor.newMembershipAmount"/>
                    </td>
                    <td>
                        &nbsp;<s:property value="contractor.currency"/>
                    </td>
        ...
        <s:elseif test="!contractor.hasFreeMembership">
            <table>
                ...
                <s:iterator value="contractor.fees.keySet()" var="feeClass">
                    <s:if test="!contractor.fees.get(#feeClass).currentLevel.free && #feeClass.membership">
                        <tr>
                            ...
                            <td class="right">
                                <s:property value="contractor.country.currency.symbol" /><s:property value="contractor.fees.get(#feeClass).currentAmount" />
                            </td>
                            <td>
                                &nbsp;<s:property value="contractor.currency"/>
                            </td>
                ...
                <tr>
                    ...
                    <td class="right">
                        <s:property value="contractor.country.currency.symbol" /><s:property value="contractor.currentMembershipAmount"/>
                    </td>
                    <td>
                        &nbsp;<s:property value="contractor.currency"/>
                    </td>
                ...
                <tr id="operator_<s:property value="operatorAccount.id"/>">
                    <s:if test="contractor.status.activeDemo">
                        <td>
                            ...
                            <s:a href="%{flagUrl}"><s:property value="flagColor.smallIcon" escape="false" /></s:a>
                        </td>
                    ...
                    <pics:permission perm="RemoveContractors">
                        <td>
                            <a id="facility_<s:property value="operatorAccount.id"/>" 
                                href="#" 
                                class="remove" 
                                onclick="javascript: return removeOperator( <s:property value="contractor.id"/>, <s:property value="operatorAccount.id"/> );"
                            ><s:text name="global.Remove"/></a>
                        </td>
                    </pics:permission>
