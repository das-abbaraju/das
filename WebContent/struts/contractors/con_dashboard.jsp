            ...
            <s:iterator value="problems.categories" id="probcat">
                <s:iterator value="problems.getCriteria(#probcat)" id="probcrit">
                    <li>
                        ...
                        <span title="<s:property value="getPercentComplete(#probcrit, opID)" />"><s:property
                                value="label"/></span>
                    ...
                    <ul>
                        <pics:permission perm="ContractorDetails">
                            <s:if test="#widget.key == 'global.DocuGUARD'">
                                <li>
                                    <strong><a class="pdf"
                                               href="AuditPdfConverter.action?id=<s:property value="id"/>"><s:text
                                            name="ContractorView.DownloadPQF"/></a></strong>
                                </li>
                            </s:if>
                        </pics:permission>
                        ...
                        <div class="flagData">
                            ...
                            <ul>
                                <s:iterator value="criteriaList.getCriteria(#datacat)" id="datacrit">
                                    <li>
                                        <span title="<s:property value="criteriaList.getWorstFlagOperators(#datacrit)" />"><s:property
                                                value="criteriaList.getWorstColor(#datacrit).smallIcon" escape="false"/> <s:property
                                                value="label"/></span>
                                    </li>
                                </s:iterator>
                            </ul>
            ...
            <div class="telecommunications">
                ...
                <s:if test="contractor.webUrl.length() > 0">
                    <p class="url">
                        ...
                        <strong><a href="http://<s:property value="contractor.webUrl" />" class="value" target="_blank"><s:property
                                value="contractor.webUrl"/></a></strong>
                    </p>
                </s:if>
    ...
    <div class="panel">
        ...
        <div class="panel_content">
            ...
            <s:if test="@com.picsauditing.util.Strings@isEmpty(contractor.brochureFile) == false">
                <p class="web">
                    <strong>
                        <a href="DownloadContractorFile.action?id=<s:property value="id" />" target="_BLANK"><s:text
                                name="ContractorEdit.CompanyIdentification.CompanyBrochure"/></a>
                    </strong>
                </p>
            </s:if>
    ...
    <div class="panel">
        ...
        <div class="panel_content" style="text-align: center;">
            <s:form id="form_sync">
                ...
                <input type="submit" class="picsbutton"
                       onclick="$(this).attr('disabled', true); $('#form_sync').submit();" style="margin: 5px auto;"
