...
<form action="Contact">
	...
	<ol>
		...
		<li><label>Phone:</label><s:property value="permissions.picsMainPhone" /></li>
		<li><label>Toll Free:</label><s:property value="permissions.picsTollFreePhone" /></li>
		<li><label>Fax:</label><s:property value="permissions.picsFax" /></li>
