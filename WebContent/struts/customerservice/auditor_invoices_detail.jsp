...
<table class="report" id="invoicedetail">
	...
	<tr>
		...
		<td class="right"><s:property value="contractorAccount.currencyCode.symbol" /><s:if test="auditType.id == 2">75</s:if> </td>
	</tr>
	</s:iterator>
	<tr>
		<td></td>
		<td class="right" colspan="3"><h4>Total</h4></td>
		<td class="right"><h4><s:property value="contractorAccount.currencyCode.symbol" /><s:property value="total"/></h4></td>
	</tr>
</table>
