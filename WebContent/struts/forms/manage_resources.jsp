	...
	<ol>
		...
		<li>
			...
			<li>
				...
				<s:else>
					<s:select name="locale" list="@com.picsauditing.jpa.entities.AppTranslation@getLocales()" listValue="@org.apache.commons.lang.StringUtils@capitalize(getDisplayName(language))" theme="" />
					<div class="fieldhelp">
