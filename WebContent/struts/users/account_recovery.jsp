...
<s:form id="accountRecovery">
	...
	<div style="width: 500px;">
		<fieldset class="form">
		<h2 class="formLegend">
			<span class="form-title"><s:text name="AccountRecovery.title" /></span>
		</h2>
		<ol style="margin-top:7px;">
			<li class="showUser">
				<div><label><s:text name="global.Username" />:</label> <s:textfield id="usernameBox" name="username" cssClass="login" /></div>
				<div class="fieldhelp">
					<h3><s:text name="global.Username" /></h3>
					<p><s:text name="AccountRecovery.Username.fieldhelp" /></p>
				</div>
			</li>
			<li class="showEmail">
				<div><label><s:text name="global.Email" />:</label><s:textfield id="emailBox" name="email" cssClass="login" size="28"/></div>
				<div class="fieldhelp">
					<h3><s:text name="global.Email" /></h3>
					<p><s:text name="AccountRecovery.Email.fieldhelp" /></p>
				</div>
			</li>
			<li>
