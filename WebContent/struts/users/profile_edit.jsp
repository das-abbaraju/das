...
<html>
	...
	<body>
		...
		<div id="internalnavcontainer">
			<ul id="navlist">
				<li>
					<a id="link_tab_profile" href="#" class="current"><s:text name="button.Edit" /></a>
				</li>
				
				<s:if test="switchTos.size > 0">
					<li>
						<a id="link_tab_switch" href="#"><s:text name="ProfileEdit.label.SwitchAccounts" /></a>
					</li>
				</s:if>
				
				<s:if test="eList.size > 0">
					<li>
						<a id="link_tab_subscriptions" href="#"><s:text name="ProfileEdit.label.EmailSubscriptions" /></a>
					</li>
				</s:if>
				
				<s:if test="!permissions.contractor">
					<li>
						<a id="link_tab_permissions" href="#"><s:text name="ProfileEdit.label.Permissions" /></a>
					</li>
				</s:if>
			</ul>
		</div>
