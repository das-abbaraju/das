	...
	<table class="report">
		<thead>
			<tr>
				...
				<td>User</td>
				<td>
					<s:text name="OpPerms.ContractorAdmin.description" />
					<span class="block" style="position: relative;">
						<img src="images/help.gif" height="15" width="15">
						<span class="hoverhelp" style="bottom: 13px; left: -99px;">
							<s:text name="OpPerms.ContractorAdmin.helpText" />
						</span>
					</span>
				</td>
				<td>
					<s:text name="OpPerms.ContractorBilling.description" />
					<span class="block" style="position: relative;">
						<img src="images/help.gif" height="15" width="15">
						<span class="hoverhelp" style="bottom: 13px; left: -99px;">
				...
				<td>
					<s:text name="OpPerms.ContractorSafety.description" />
					<span class="block" style="position: relative;">
						<img src="images/help.gif" height="15" width="15">
						<span class="hoverhelp" style="bottom: 13px; left: -99px;">
				...
				<td>
					<s:text name="OpPerms.ContractorInsurance.description" />
					<span class="block" style="position: relative;">
						<img src="images/help.gif" height="15" width="15">
						<span class="hoverhelp" style="bottom: 13px; left: -99px;">
			...
			<s:iterator value="userList" status="stat" id="user">
				<s:if test="activeB">
					<tr>
						...
						<td>
							<a href="UsersManage.action?account=<s:property value="account.id"/>&user=<s:property value="id"/>"
								title="<s:property value="#user.account.name" />">
								<s:property value="name" />
							</a>
						</td>
						<s:iterator value="@com.picsauditing.actions.users.ManageUserPermissions@permissionTypes" id="perm">
							<td class="center">
								<input
									type="checkbox"
									onclick="savePerm(<s:property value="#user.id" />, '<s:property value="#perm" />', this);"
									checked="<s:if test="userHasPermission(#user, #perm)">checked</s:if>"
								/>
							</td>
						</s:iterator>
					</tr>
