	...
	<fieldset class="form">
		...
		<ol>
			<li><label><s:text name="%{scope}.label.ClassificationType" /></label>
				<s:select list="@com.picsauditing.jpa.entities.ClassificationType@values()" name="productService.classificationType" />
			</li>
			<li><label><s:text name="%{scope}.label.ClassificationCode" /></label>
				<s:textfield cssClass="psAutocomplete" name="productService.classificationCode" />
			</li>
			<li><label><s:text name="%{scope}.label.Description" /></label>
				<s:textarea name="productService.description" />
			</li>
			<li><label><s:text name="%{scope}.label.Parent" /></label>
				<s:textfield cssClass="psAutocomplete" name="productService.parent" />
			</li>
			<li><label><s:text name="%{scope}.label.BestMatch" /></label>
				<s:textfield cssClass="psAutocomplete" name="productService.bestMatch" />
			</li>
		</ol>
	</fieldset>
	<fieldset class="form submit">
		<s:submit action="UpdateProductServiceAjax!save" value="%{getText('button.Save')}" cssClass="picsbutton positive" id="editSave" />
