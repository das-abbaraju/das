            ...
            <div id="beta_translations_alert">
                ...
                <div class="panel_placeholder" id="panel<s:property value="widgetID"/>_holder">
                    <div class="panel" id="panel<s:property value="widgetID"/>">
                        ...
                        <div id="panel<s:property value="widgetID"/>_content" class="panel_content"
                             data-widget-type="GoogleChart" data-url="js/operator/multi-series.json" data-chart-type="Bar" data-style-type="Basic">
                        </div>
                    </div>
                </div>
                ...
                <div class="panel_placeholder" id="panel<s:property value="widgetID"/>_holder">
                    <div class="panel" id="panel<s:property value="widgetID"/>">
                        ...
                        <div id="panel<s:property value="widgetID"/>_content" class="panel_content"
                             data-widget-type="GoogleChart" data-url="js/operator/multi-series.json" data-chart-type="Bar" data-style-type="Flags">
                        </div>
                    </div>
                </div>
                ...
                <div class="panel_placeholder" id="panel<s:property value="widgetID"/>_holder">
                    <div class="panel" id="panel<s:property value="widgetID"/>">
                        ...
                        <div id="panel<s:property value="widgetID"/>_content" class="panel_content"
                             data-widget-type="GoogleChart" data-url="js/operator/multi-series.json" data-chart-type="Bar" data-style-type="StackedFlags">
                        </div>
                    </div>
                </div>
                ...
                <div class="panel_placeholder" id="panel<s:property value="widgetID"/>_holder">
                    <div class="panel" id="panel<s:property value="widgetID"/>">
                        ...
                        <div id="panel<s:property value="widgetID"/>_content" class="panel_content"
                             data-widget-type="GoogleChart" data-url="js/operator/multi-series.json" data-chart-type="Column" data-style-type="Basic">
                        </div>
                    </div>
                </div>
                ...
                <div class="panel_placeholder" id="panel<s:property value="widgetID"/>_holder">
                    <div class="panel" id="panel<s:property value="widgetID"/>">
                        ...
                        <div id="panel<s:property value="widgetID"/>_content" class="panel_content"
                             data-widget-type="GoogleChart" data-url="js/operator/multi-series.json" data-chart-type="Column" data-style-type="Flags">
                        </div>
                    </div>
                </div>
                ...
                <div class="panel_placeholder" id="panel<s:property value="widgetID"/>_holder">
                    <div class="panel" id="panel<s:property value="widgetID"/>">
                        ...
                        <div id="panel<s:property value="widgetID"/>_content" class="panel_content"
                             data-widget-type="GoogleChart" data-url="js/operator/multi-series.json" data-chart-type="Column" data-style-type="StackedFlags">
                        </div>
                    </div>
                </div>
