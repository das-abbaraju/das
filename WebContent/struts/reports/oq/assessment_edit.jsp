		...
		<ol>
			...
			<s:if test="id > 0">
				<li><label>Primary Contact:</label>
					...
					<a href="UsersManage!add.action?account=<s:property value="center.id"/>&isActive=<s:property value="isActive"/>&isGroup=<s:property value="isGroup"/>&userIsGroup=No">Add User</a>
				</li>
			</s:if>				
		</ol>
	</fieldset>
