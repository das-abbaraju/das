...
<table class="report">
	...
	<tr>
		...
		<th class="right"><a href="javascript: changeOrderBy('form1','dueDate');">Due Date</a></th>	    
	</tr>
	</thead>
	<tbody>
	<s:iterator value="data" status="stat">
		<tr>
			...
			<td><a href="InvoiceDetail.action?id=<s:property value="get('invoiceId')"/>"><s:property value="get('invoiceId')"/></a></td>
