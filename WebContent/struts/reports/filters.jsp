	...
	<s:form id="form1" action="%{filter.destinationAction}">
		...
		<div>
			<s:if test="filter.allowMailMerge">
				<button type="submit" id="write_email_button" name="button"
					value="Write Email" class="picsbutton positive" style="display: none">
					<s:text name="Filters.button.WriteEmail" />
				</button>
				<button type="button" id="find_recipients" name="button"
					value="Find Recipients" class="picsbutton">
			...
			<s:else>
				<s:if test="filter.allowMailReport">
					<button type="submit" id="send_report_button" name="button"
						value="Email Report" class="picsbutton positive" style="display: none">
		...
		<s:if test="filter.showStatus">
			<div class="filterOption" id="status">
				...
				<span class="clearLink q_box select">
					<s:select list="filter.statusList" listValue="%{getTextNullSafe(i18nKey)}"
						multiple="true" cssClass="forms" name="filter.status" />
					<br />
		...
		<s:if test="filter.showType">
			<div class="filterOption" id="type">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select list="filter.typeList" multiple="true" cssClass="forms"
						name="filter.type" />
					<br />
					<a class="clearLink" href="#">
						<s:text name="Filters.status.Clear" />
		...
		<s:if test="filter.showRequestStatus">
			<div class="filterOption">
				...
				<s:select cssClass="forms"
					...
					listKey="name()" listValue="getTextNullSafe(getI18nKey())"
					name="filter.requestStatus" headerKey=""
		...
		<s:if test="filter.showReferralStatus">
			<div class="filterOption">
				...
				<s:select cssClass="forms"
					...
					listKey="name()" listValue="getTextNullSafe(getI18nKey())"
					name="filter.referralStatus" headerKey=""
					headerValue="%{getTextNullSafe('Filters.status.Any')}" />
			</div>
		</s:if>
			...
			<div class="filterOption">
				...
				<span class="clearLink q_box select">
					<s:select
						...
						cssClass="forms" name="filter.accountLevel" multiple="true" size="3" />
			...
			<div class="filterOption">
				...
				<span class="clearLink q_box select">
					...
					<s:radio
						...
						name="filter.showSelfPerformedTrade" theme="pics" cssClass="inline" />
				</span>
			</div>
		</s:if>
		...
		<s:if test="filter.showMinorityOwned">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select list="filter.minorityQuestions" cssClass="forms"
						name="filter.minorityQuestion" multiple="true" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if test="filter.showFlagStatus">
			...
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select list="filter.flagStatusList"
						listValue="%{getTextNullSafe(i18nKey)}" cssClass="forms"
						name="filter.flagStatus" multiple="true" size="3"
		...
		<s:if test="filter.showWaitingOn">
			<div class="filterOption">
				<s:select list="filter.waitingOnList"
					listValue="%{getTextNullSafe(value.i18nKey)}" headerKey=""
					headerValue="- %{getTextNullSafe('global.WaitingOn')} -" cssClass="forms"
		...
		<s:if test="filter.showProductRiskLevel">
			<div class="filterOption" id="productRisklevel">
				...
				<span class="clearLink q_box select">
					<s:select
						list="#{1:getTextNullSafe('LowMedHigh.Low'), 2:getTextNullSafe('LowMedHigh.Med'), 3:getTextNullSafe('LowMedHigh.High')}"
						cssClass="forms" name="filter.productRiskLevel" multiple="true" size="3" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
			...
			<div class="filterOption" id="service">
				...
				<span class="clearLink q_box select">
					<s:select
						...
						cssClass="forms" name="filter.service" multiple="true" size="3" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if
			...
			<div class="filterOption">
				<s:select list="filter.operatorTagNamesList" cssClass="forms"
					name="filter.operatorTagName" listKey="id" listValue="tag" headerKey="0"
		...
		<s:if test="filter.showHandledBy">
			<div class="filterOption">
				<s:select list="filter.handledByList"
					listValue="%{getTextNullSafe(i18nKey)}" headerKey=""
		...
		<s:if test="filter.showCcOnFile">
			<div class="filterOption">
				<s:select
					...
					headerKey="2" headerValue="- %{getTextNullSafe('global.CreditCard')} -"
					cssClass="forms" name="filter.ccOnFile" />
			</div>
		</s:if>
		...
		<s:if test="filter.showContractor">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:textfield rel="'Contractors'" name="filter.contractor"
						cssClass="tokenAuto" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				...
				<s:else>
					...
					<span class="clearLink q_box select">
						...
						<s:radio
							...
							name="filter.showAnyOperator" theme="pics" cssClass="inline" />
					</span>
				</s:else>
			</div>
		</s:if>
		...
		<s:if test="filter.showExcludeOperators">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:textfield rel="'Operator'" name="filter.excludeOperators"
						cssClass="tokenAuto" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
		...
		<s:if test="filter.showGeneralContractors">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:textfield rel="'GeneralContractor'" name="filter.generalContractor"
						cssClass="tokenAuto" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
		...
		<s:if test="filter.showOperatorTags">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select list="filter.operatorTagsList" cssClass="forms"
						name="filter.operatorTags" listKey="id"
			...
			<div class="filterOption">
				...
				<span class="clearLink q_box select">
					<s:select list="filter.waAuditTypesList" cssClass="forms"
						name="filter.waAuditTypes" listKey="id" listValue="name" multiple="true"
						size="5" />
					<br />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
		...
		<s:if test="filter.showCaoOperator">
			...
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:textfield rel="'Operator'" name="filter.caoOperator"
						cssClass="tokenAuto" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
					<s:radio
						list="#{'false':getTextNullSafe('JS.Filters.status.All'),'true':getTextNullSafe('Filters.status.Any')}"
						name="filter.showAnyCAOOperator" theme="pics" cssClass="inline" />
				</span>
			</div>
		</s:if>
		...
		<s:if test="filter.showPqfType">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select list="filter.pQFTypeList" cssClass="forms"
						name="filter.pqfTypeID" listKey="id" listValue="name" multiple="true"
						size="5" />
					<br />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
		...
		<s:if test="filter.showAuditType">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select list="filter.auditTypeList" cssClass="forms"
						name="filter.auditTypeID" listKey="id" listValue="name" multiple="true"
						size="5" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
		...
		<s:if test="filter.showPolicyType">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select list="filter.policyTypeList" cssClass="forms"
						name="filter.auditTypeID" listKey="id" listValue="name" multiple="true"
						size="5" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
		...
		<s:if test="filter.showAuditStatus">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select id="form1_auditStatus" list="filter.auditStatusList"
						listValue="%{getTextNullSafe(i18nKey)}" cssClass="forms"
		...
		<s:if test="filter.showCaowStatus">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select id="form1_caowStatus" list="filter.auditStatusList"
						listValue="%{getTextNullSafe(i18nKey)}" cssClass="forms"
		...
		<s:if test="filter.showAuditor">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select name="filter.auditorId" cssClass="forms" list="safetyList"
		...
		<s:if test="filter.showClosingAuditor">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select name="filter.closingAuditorId" cssClass="forms" list="safetyList"
		...
		<s:if test="filter.showAccountManager">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select name="filter.accountManager" cssClass="forms"
						list="accountManagers" listKey="id" listValue="name" multiple="true"
						size="5" id="form1_accountManager" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if test="filter.showConAuditor">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select name="filter.conAuditorId" cssClass="forms" list="auditorList"
						listKey="id" listValue="name" multiple="true" size="5"
		...
		<s:if test="filter.showMarketingUsers">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select name="filter.marketingUsers" cssClass="forms"
						list="filter.marketingUsersList" listKey="id" listValue="name"
		...
		<s:if test="filter.showConLicense">
			...
			<div class="filterOption">
				<s:select name="filter.validLicense"
		...
		<s:if test="filter.showPercentComplete">
			<div class="filterOption">
				...
				<span class="clearLink q_box textfield">
					...
					<s:text name="Filters.label.To" />
					:
					<s:textfield name="filter.percentComplete2" cssClass="forms" size="12" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if test="filter.showPercentVerified">
			<div class="filterOption">
				...
				<span class="clearLink q_box textfield">
					...
					<s:text name="Filters.label.To" />
					:
					<s:textfield name="filter.percentVerified2" cssClass="forms" size="12" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if test="filter.showAuditFor">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select id="form1_auditFor" list="filter.yearList" cssClass="forms"
						name="filter.auditFor" multiple="true" size="5" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if test="filter.showShaTypeFlagCriteria">
			...
			<div class="filterOption">
				<s:select list="filter.oshaTypesList" cssClass="forms"
					name="filter.shaTypeFlagCriteria" headerKey=""
					headerValue="- %{getTextNullSafe('Filters.header.OSHAType')} -" />
			</div>
		</s:if>
		...
		<s:if test="filter.showEmrRange">
			...
			<div class="filterOption">
				...
				<span class="clearLink q_box textfield">
					...
					<s:text name="Filters.label.To" />
					:
					<s:textfield name="filter.maxEMR" cssClass="forms" size="12" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if test="filter.showTrirRange">
			...
			<div class="filterOption">
				...
				<span class="clearLink q_box textfield">
					...
					<s:text name="Filters.label.To" />
					:
					<s:textfield name="filter.maxTRIR" cssClass="forms" size="12" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if test="filter.showScoreRange">
			...
			<div class="filterOption">
				...
				<span class="clearLink q_box textfield">
					...
					<s:text name="Filters.label.To" />
					:
					<s:textfield name="filter.scoreMax" cssClass="forms" size="12" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
		...
		<s:if test="filter.showAMBest">
			...
			<div class="filterOption">
				<s:select list="filter.aMBestRatingsList" cssClass="forms"
					name="filter.amBestRating" headerKey="0"
					headerValue="- %{getTextNullSafe('Filters.header.Rating')} -" />
				<s:select list="filter.aMBestClassList" cssClass="forms"
					name="filter.amBestClass" headerKey="0"
			...
			<div class="filterOption">
				<span>
					...
					<s:radio
						...
						name="filter.billingCountrySubdivision" theme="pics" cssClass="inline" />
				</span>
			</div>
		</s:if>
		...
		<s:if test="filter.showEmailTemplate">
			...
			<div class="filterOption">
				<s:select list="filter.emailTemplateList" headerKey="0"
					headerValue="- %{getTextNullSafe('EmailTemplate')} -" cssClass="forms"
					name="filter.emailTemplate" listKey="id" listValue="templateName" />
			</div>
			<div class="filterOption">
				<s:text name="Filters.label.EmailSentDate" />
				<s:textfield cssClass="forms datepicker" size="10" id="form1_emailSentDate"
		...
		<s:if test="filter.showCreationDate">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box textfield">
					<s:textfield cssClass="forms datepicker" size="10" id="form1_creationDate1"
						name="filter.creationDate1"
						value="%{maskDateFormat(filter.creationDate1)}" />
					<s:text name="Filters.label.To" />
					:
					<s:textfield cssClass="forms datepicker" size="10" id="form1_creationDate2"
		...
		<s:if test="filter.showClosedOnDate">
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box textfield">
					<s:textfield cssClass="forms datepicker" size="10" id="form1_closedOnDate1"
						name="filter.closedOnDate1"
						value="%{maskDateFormat(filter.closedOnDate1)}" />
					<s:text name="Filters.label.To" />
					:
					<s:textfield cssClass="forms datepicker" size="10" id="form1_closedOnDate2"
		...
		<pics:toggle name="RequestNewContractorAccount">
			<s:if test="filter.showInsideSalesPriority">
				<div class="filterOption" id="inside_sales_priority">
					<a href="#" class="filterBox">
					...
					<br />
					<span class="clearLink q_box select">
						<s:select list="filter.insideSalesPriorities" listValue="%{getTextNullSafe(i18nKey)}"
							multiple="true" cssClass="forms" name="filter.insideSalesPriority" />
						<br />
						<a class="clearLink" href="javascript:;">
							<s:text name="Filters.status.Clear" />
						</a>
					</span>
				</div>
		...
		<s:if test="filter.showDeactivationReason">
			<div class="filterOption">
				<s:select list="filter.deactivationReasons" headerKey=" "
					headerValue="- %{getTextNullSafe('Filters.header.DeactivationReason')} -"
					listKey="key" listValue="value" cssClass="forms"
		...
		<s:if test="filter.showInsuranceLimits">
			<div class="filterOption">
				<a href="#"
					onclick="showInsuranceTextBoxes('form1_insuranceLimits'); return false;">
				...
				<div id="form1_insuranceLimits" style="display: none"
					class="clearLink q_box">
					<table class="insuranceLimits">
						<tr>
							<td class="clearLink"
								title="<s:text name="Filters.help.GLEachOccurence" />">
								<s:text name="Filters.label.GLEachOccurence" />
								:
							</td>
							<td>
								$
								<s:textfield id="form1_insuranceLimits1" cssClass="forms"
						...
						<tr>
							<td class="clearLink"
								title="<s:text name="Filters.help.GLGeneralAggregate" />">
								<s:text name="Filters.label.GLGeneralAggregate" />
								:
							</td>
							<td>
								$
								<s:textfield id="form1_insuranceLimits2" cssClass="forms"
									title="%{getTextNullSafe('Filters.help.EnterANumber')}"
									name="filter.glGeneralAggregate" onfocus="clearInsuranceText(this);"
									onblur="resetEmptyField(this);" onkeyup="isNumber(this,2);" size="15" />
								<span id="error2" class="redMain"></span>
							</td>
						</tr>
						<tr>
							<td class="clearLink"
								title="<s:text name="Filters.help.ALCombinedSingle" />">
								<s:text name="Filters.label.ALCombinedSingle" />
								:
							</td>
							<td>
								$
								<s:textfield id="form1_insuranceLimits3" cssClass="forms"
									title="%{getTextNullSafe('Filters.help.EnterANumber')}"
									name="filter.alCombinedSingle" onfocus="clearInsuranceText(this);"
									onblur="resetEmptyField(this);" onkeyup="isNumber(this,3);" size="15" />
								<span id="error3" class="redMain"></span>
							</td>
						</tr>
						<tr>
							<td class="clearLink"
								title="<s:text name="Filters.help.WCEachAccident" />">
								<s:text name="Filters.label.WCEachAccident" />
								:
							</td>
							<td>
								$
								<s:textfield id="form1_insuranceLimits4" cssClass="forms"
									title="%{getTextNullSafe('Filters.help.EnterANumber')}"
									name="filter.wcEachAccident" onfocus="clearInsuranceText(this);"
									onblur="resetEmptyField(this);" onkeyup="isNumber(this,4);" size="15" />
								<span id="error4" class="redMain"></span>
							</td>
						</tr>
						<tr>
							<td class="clearLink"
								title="<s:text name="Filters.help.EXEachOccurence" />">
								<s:text name="Filters.label.EXEachOccurence" />
								:
							</td>
							<td>
								$
								<s:textfield id="form1_insuranceLimits5" cssClass="forms"
									title="%{getTextNullSafe('Filters.help.EnterANumber')}"
									name="filter.exEachOccurrence" onfocus="clearInsuranceText(this);"
									onblur="resetEmptyField(this);" onkeyup="isNumber(this,5);" size="15" />
					...
					<a class="clearLink" href="#"
						onclick="clearInsuranceTextFields('form1_insuranceLimits'); return false;">
						<s:text name="Filters.status.Clear" />
					</a>
				</div>
			</div>
		...
		<s:if test="filter.showQuestionAnswer">
			...
			<div class="filterOption">
				...
				<br />
				<span class="clearLink q_box select">
					<s:select name="filter.questionIds" cssClass="forms"
						list="filter.questionsByAuditList" listKey="id" listValue="name"
						multiple="true" size="23" />
					<a href="#" class="clearLink">
						<s:text name="Filters.status.Clear" />
					</a>
				</span>
