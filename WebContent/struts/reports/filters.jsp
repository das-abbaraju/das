...
<s:form id="form1" action="%{filter.destinationAction}">
	...
	<div>
		<s:if test="filter.allowMailMerge">
			...
			value="Write Email" class="picsbutton positive" style="display: none"><s:text name="Filters.button.WriteEmail" /></button>
			<button type="button" id="find_recipients" name="button" value="Find Recipients" class="picsbutton"><s:text name="Filters.button.FindRecipients" /></button>
		</s:if>
		<s:else>
	...
	<s:if test="filter.showWorkStatus">
		<div class="filterOption">
			...
			<s:select list="#{'Y':getText('YesNo.Yes'),'N':getText('YesNo.No'),'P':getText('Filters.status.Pending')}" 
	...
	<s:if test="filter.showRiskLevel">
		<div class="filterOption" id="risklevel">
			...
			<span class="q_status"><s:text name="JS.Filters.status.All" /></span><br />
			<span class="clearLink q_box select">
				<s:select list="#{1:getText('LowMedHigh.Low'), 2:getText('LowMedHigh.Med'), 3:getText('LowMedHigh.High')}"
	...
	<s:if test="filter.showService">
		<div class="filterOption" id="service">
			...
			<span class="q_status"><s:text name="JS.Filters.status.All" /></span><br />
			<span class="clearLink q_box select">
				<s:select list="#{'Onsite':getText('ContractorType.Onsite'), 'Offsite':getText('ContractorType.Offsite'), 'Material Supplier':getText('ContractorType.Material')}" 
	...
	<s:if test="filter.showOpertorTagName && filter.operatorTagNamesList.size() > 0">
		<div class="filterOption">
			<s:select list="filter.operatorTagNamesList" cssClass="forms" name="filter.operatorTagName" listKey="id" 
				listValue="tag" headerKey="0" headerValue="- %{getText('Filters.header.Tag')} -" />
		</div>
	</s:if>
	...
	<s:if test="filter.showCcOnFile">
		<div class="filterOption">
			<s:select list="#{'1':getText('YesNo.Yes'),'0':getText('YesNo.No')}" headerKey="2" 
				headerValue="- %{getText('global.CreditCard')} -" cssClass="forms" name="filter.ccOnFile" />
		</div>
	</s:if>
		...
		<div class="filterOption">
			...
			<s:else>
				...
				<span class="clearLink q_box select">
					...
					<a class="clearLink" href="#"><s:text name="Filters.status.Clear" /></a>
					<s:radio list="#{'false':getText('JS.Filters.status.All'),'true':getText('Filters.status.Any')}"
	...
	<s:if test="filter.showAuditType">
		<div class="filterOption">
			<a href="#" class="filterBox"><s:text name="AuditType" /></a> =
			<span ><s:text name="JS.Filters.status.All" /></span><br />
			<span class="clearLink q_box select">
				<s:select list="filter.auditTypeList" cssClass="forms" name="filter.auditTypeID" listKey="id" 
					listValue="name" multiple="true" size="5" />
				<a class="clearLink" href="#"><s:text name="Filters.status.Clear" /></a>
			</span>
		</div>
	...
	<s:if test="filter.showConLicense">
		<br clear="all" />
		<div class="filterOption">
			<s:select name="filter.validLicense" list="#{'Valid':getText('Filters.status.Valid'),'UnValid':getText('Filters.status.Invalid'),'All':getText('JS.Filters.status.All')}"
				cssClass="forms" />
		</div>
	</s:if>
	...
	<s:if test="filter.showUnConfirmedAudits">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.unScheduledAudits" /> <s:text name="Filters.label.SearchUnconfirmedAudits" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showAssignedCon">
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.assignedCon" /> <s:text name="Filters.label.SearchAssignedContractors" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showExpiredLicense">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.conExpiredLic" /> <s:text name="Filters.label.SearchExpiredLicenses" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showInParentCorporation">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.inParentCorporation" /> <s:text name="Filters.label.LimitContractorsWorkingInParent" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showAuditFor">
		<div class="filterOption">
			...
			<span class="q_status"><s:text name="JS.Filters.status.All" /></span><br />
			<span class="clearLink q_box select">
				<s:select id="form1_auditFor" list="filter.yearList" cssClass="forms" name="filter.auditFor"
	...
	<s:if test="filter.showShaType">
		<br clear="all" />
		<div class="filterOption">
			<s:select list="filter.oshaTypesList" cssClass="forms" name="filter.shaType" headerKey=""
	...
	<s:if test="filter.showShaTypeFlagCriteria">
		<br clear="all" />
		<div class="filterOption">
			<s:select list="filter.oshaTypesList" cssClass="forms" name="filter.shaTypeFlagCriteria" headerKey=""
				headerValue="- %{getText('Filters.header.OSHAType')} -" />
		</div>
	</s:if>
	...
	<s:if test="filter.showIncidenceRate">
		<div class="filterOption">
			<s:text name="Filters.label.IncidenceRate" /> <s:textfield name="filter.incidenceRate" cssClass="forms" size="10"  />
			<s:text name="Filters.label.To" /> <s:textfield name="filter.incidenceRateMax" cssClass="forms" size="10"  />
		</div>
	</s:if>

	<s:if test="filter.showIncidenceRateAvg">
		<div class="filterOption">
			<s:text name="Filters.label.3YearAverage" /> <s:textfield name="filter.incidenceRateAvg" cssClass="forms" size="10"  />
			<s:text name="Filters.label.To" /> <s:textfield name="filter.incidenceRateAvgMax" cssClass="forms" size="10"  />
		</div>
	</s:if>

	<s:if test="filter.showCohsStats">
		<div class="filterOption">
			<s:text name="Filters.label.Cad7" /> <s:textfield name="filter.cad7" cssClass="forms" size="10"  />
			<s:text name="Filters.label.Neer" /> <s:textfield name="filter.neer" cssClass="forms" size="10"  /></div>
	</s:if>

	<s:if test="filter.showAMBest">
		<br clear="all" />
		<div class="filterOption">
			<s:select list="filter.aMBestRatingsList" cssClass="forms" name="filter.amBestRating" headerKey="0"
				headerValue="- %{getText('Filters.header.Rating')} -" />
			<s:select list="filter.aMBestClassList" cssClass="forms" name="filter.amBestClass" headerKey="0"
				headerValue="- %{getText('Filters.header.Class')} -" />
		</div>
	</s:if>
	...
	<s:if test="filter.showViewAll">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.viewAll" /> <s:text name="Filters.label.ShowAllRegistrationRequests" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showInsuranceLimits">
		<div class="filterOption">
			...
			<span id="form1_insuranceLimits_query">= <s:text name="JS.Filters.status.All" /></span><br />
				<div id="form1_insuranceLimits" style="display: none"class="clearLink q_box">
					<table class="insuranceLimits">
						<tr>
							<td class="clearLink" title="<s:text name="Filters.help.GLEachOccurence" />"><s:text name="Filters.label.GLEachOccurence" />:</td>
							<td>
								$<s:textfield id="form1_insuranceLimits1" cssClass="forms" title="%{getText('Filters.help.EnterANumber')}"
						...
						<tr>
							<td class="clearLink" title="<s:text name="Filters.help.GLGeneralAggregate" />"><s:text name="Filters.label.GLGeneralAggregate" />:</td>
							<td>
								$<s:textfield id="form1_insuranceLimits2" cssClass="forms" title="%{getText('Filters.help.EnterANumber')}"
						...
						<tr>
							<td class="clearLink" title="<s:text name="Filters.help.ALCombinedSingle" />"><s:text name="Filters.label.ALCombinedSingle" />:</td>
							<td>
								$<s:textfield id="form1_insuranceLimits3" cssClass="forms" title="%{getText('Filters.help.EnterANumber')}" name="filter.alCombinedSingle"
						...
						<tr>
							<td class="clearLink" title="<s:text name="Filters.help.WCEachAccident" />"><s:text name="Filters.label.WCEachAccident" />:</td>
							<td>
								$<s:textfield id="form1_insuranceLimits4" cssClass="forms" title="%{getText('Filters.help.EnterANumber')}" name="filter.wcEachAccident"
						...
						<tr>
							<td class="clearLink" title="<s:text name="Filters.help.EXEachOccurence" />"><s:text name="Filters.label.EXEachOccurence" />:</td>
							<td>
								$<s:textfield id="form1_insuranceLimits5" cssClass="forms" title="%{getText('Filters.help.EnterANumber')}" name="filter.exEachOccurrence"
	...
	<s:if test="filter.showQuestionAnswer">
		...
		<div class="filterOption">
			...
			<span class="q_status"><s:text name="JS.Filters.status.All" /></span><br />
			<span class="clearLink q_box select">
				<s:select name="filter.questionIds" cssClass="forms" list="filter.questionsByAuditList" listKey="id"
	...
	<s:if test="filter.showConWithPendingAudits">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.pendingPqfAnnualUpdate" /> <s:text name="Filters.label.ShowContractorsPendingPQFAU" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showNotRenewingContractors">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.notRenewingContractors" /> <s:text name="Filters.label.ShowContractorsNotRenew" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showContractorsWithPendingMembership">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.contractorsWithPendingMembership" /> <s:text name="Filters.label.ShowContractorsUnpaidMembership" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showPrimaryInformation">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.primaryInformation" /> <s:text name="Filters.label.ShowContactInfo" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showTradeInformation">
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.tradeInformation" /> <s:text name="Filters.label.ShowTradeInfo" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showOQ">
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.oq" /> <s:text name="Filters.label.ShowOQContractors" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showHSE">
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.hse" /> <s:text name="Filters.label.ShowRequiresCompetencyReviews" />
			</label>
		</div>
	</s:if>
	<s:if test="filter.showSoleProprietership">
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.soleProprietership" /> <s:text name="Filters.label.ShowSoleProprietors" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showAuditCreationFlagChanges">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.auditCreationFlagChanges" /> <s:text name="Filters.label.ShowFlagChangesRelatedNewAudits" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showAuditStatusFlagChanges">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.auditStatusFlagChanges" /> <s:text name="Filters.label.ShowFlagChangesAuditStatusChanges" />
			</label>
		</div>
	</s:if>
	...
	<s:if test="filter.showAuditQuestionFlagChanges">
		...
		<div class="filterOption">
			<label>
				<s:checkbox name="filter.auditQuestionFlagChanges" /> <s:text name="Filters.label.ShowAuditQuestionFlagChanges" />
			</label>
		</div>
	</s:if>
