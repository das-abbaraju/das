...
<div id="search"><s:if test="allowCollapsed">
	...
	<s:if test="filter.showIndustry">
		<div class="filterOption"><a href="#"
			...
			id="form1_industry_query">ALL</span> 
		<br />
		...
		<s:select id="form1_industry" list="filter.industryList" cssClass="forms"
			name="filter.industry" multiple="true" size="10" listKey="id" listValue="name" />
	...
	<s:if test="filter.showMinorityOwned">
		<div class="filterOption"><s:select cssClass="forms"
			list="#{2340:'Small Business',2354:'Minority-Owned',2373:'Women-Owned',3543:'Disabled Veteran Owned',66:'Union Personnel',77:'Non-union Personnel', 3:'All the Above'}"
