...
<s:form id="form1" action="%{filter.destinationAction}">
	...
	<div>
		<s:if test="filter.allowMailMerge" >
			<button type="submit" id="write_email_button" name="button" value="Write Email" onclick="clickSearchSubmit('form1')" class="picsbutton positive" style="display: none">Write Email</button>
	...
	<s:if test="filter.showIndustry">
		...
		<span id="form1_industry_select" style="display: none"
			...
			list="filter.industryList" listValue="description" cssClass="forms" multiple="true" size="5" /> <script
	...
	<s:if test="filter.showOperator">
		...
		<span id="form1_operator_select" style="display: none"
			...
			multiple="true" size="10" /> <script type="text/javascript">updateQuery('form1_operator');</script>
		<br />
		<a class="clearLink" href="#"
	...
	<s:if test="filter.showAuditFor">
		...
		<span id="form1_auditFor_select" style="display: none"
			class="clearLink"> <s:select id="form1_auditFor" list="#{'2009':'2009','2008':'2008','2007':'2007','2006':'2006','2005':'2005','2004':'2004','2003':'2003','2002':'2002','2001':'2001'}"
