...
<s:form action="%{filter.destinationAction}">
	...
	<div align="center">
		<button id="searchfilter" type="button" name="button" value="Search" class="picsbutton positive">Search</button>
	</div>
	...
	<s:if test="filter.showAccountName">
		<div class="filterOption">Name: <s:textfield name="filter.accountName" cssClass="forms" size="10" /></div>
	</s:if>

	<s:if test="filter.showVisible">
		<div class="filterOption"><s:select list="filter.visibleOptions" cssClass="forms" name="filter.visible" /></div>
	</s:if>
	...
	<h3><a href="#">Contractor Details</a></h3>
	<div>
	<s:if test="filter.showAddress">
		<div class="filterOption">Address:
			<s:textfield name="filter.city" cssClass="forms" size="15" />
			<s:select list="filter.stateList" cssClass="forms" name="filter.state" />
			<s:textfield name="filter.zip" cssClass="forms" size="5" />
		</div>
	</s:if>
	
		<s:if test="filter.showTaxID">
		<div class="filterOption"><s:textfield name="filter.taxID" cssClass="forms" size="9" title="must be 9 digits" /></div>
	</s:if>
	
	<s:if test="filter.showIndustry">
		<br clear="all"/>
		<div class="filterOption">
			<a href="#" class="toggle">Industry</a> = <span	class="summary">ALL</span><br />
			<div class="editor">
				<s:select id="form1_industry" name="filter.industry" list="filter.industryList" listValue="description" cssClass="forms" multiple="true" size="5" />
				<br />
	...
	<s:if test="filter.showClosingAuditor">
		<div class="filterOption"><a href="#"
			onclick="toggleBox('form1_closingAuditorId'); return false;">Closing Auditors</a> = <span
	...
	<s:if test="filter.showPercentComplete">
		<div class="filterOption"><a href="#" onclick="showTextBox('form1_percentComplete'); return false;">Percent Complete</a> 
			...
			id="form1_percentComplete1" cssClass="forms" size="12" /> To: 
			<s:textfield name="filter.percentComplete2" id="form1_percentComplete2"
			cssClass="forms" size="12" />
			<script
	...
	<s:if test="filter.showEmrRange">
		...
		<div class="filterOption"><a href="#" onclick="showTextBox('form1_emr'); return false;">EMR</a> 
			...
			id="form1_emr1" cssClass="forms" size="12" /> To: 
	...
	<h3><a href="#">Columns to Display</a></h3>
	<div>
