<%@ taglib prefix="s" uri="/struts-tags"%><%@ taglib prefix="pics" uri="pics-taglib"%>"Contractor ID","Contractor Name",<s:if test="permissions.operator">Flag,<pics:permission perm="ViewUnApproved">"Approved",</pics:permission></s:if>"Registration Date",Risk,<s:if test="showContact">"Contact Name",Email,Address,City,State,Zip,Phone,Phone2,"Secondary Contact",Phone,Email,Website,</s:if><s:if test="showTrade">Industry,Trade,</s:if>Fax,"Billing Contact",Phone,Email
