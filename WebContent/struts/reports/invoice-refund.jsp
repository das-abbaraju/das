...
<html>
    ...
    <body>
        ...
        <s:include value="/struts/layout/_page-header.jsp">
            <s:param name="title"><s:text name="InvoiceRefund.pageHeader.title" /></s:param>
            <s:param name="subtitle"><s:text name="InvoiceRefund.pageHeader.subtitle" /></s:param>
        </s:include>
        ...
        <div id="main" class="container">
            ...
            <form action="InvoiceRefund!doRefund.action?invoice.id=${invoice.id}" method="post" id="" name="" class="form-horizontal">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <s:text name="InvoiceRefund.table.headerNameAndDescription" />
                                </th>
                                <th>
                                    <s:text name="InvoiceRefund.table.headerFee" />
                                </th>
                            </tr>
                        </thead>
                        <tbody>
