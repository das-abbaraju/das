...
<html>
<head>
<title>Field Audit for <%=aBean.name%></title>
...
<table border="0" cellspacing="0" cellpadding="1" class="blueMain">
	...
	<tr align="center" class="blueMain">
		<td class="blueHeader">Field Audit for <%=aBean.name%></td>
	</tr>
	<tr align="center">
		<td class="redmain"></td>
	</tr>
	...
	<tr align="center">
		...
		<table width="657" border="0" cellpadding="1" cellspacing="1">
			...
			<tr class="blueMain" <%=aqBean.getBGColor()%>>
				...
				<td valign="top" width="130"><%=com.picsauditing.PICS.Inputs.getYesNoNARadio("auditAnswer_" + numQuestions, "forms", "")%>
				<br>
				<input type="text" name="auditTextAnswer_<%=numQuestions%>"
					class="forms" size="25" value=""></td>
			</tr>
			<%
				}//while
					aqBean.closeList();
		...
		<br>
		<span align="left"> <input name="action" type="submit"
			class="forms" value="Save"> click to save your work. You may
		still edit this audit later.
		<p><input name="action" type="submit" class="forms" value="Submit">
		click to complete this phase of the audit & view the requirements.
		<p><input name="action" type="submit" class="forms" value="Reset">
		click to reset status of this audit to "Scheduled." This will delete
		all audit data.
		</span></td>
	</tr>
</table>
<input type="hidden" name="timedOut" value=""> <input
	type="hidden" name="action" value="timeoutsave"></form>
</body>
</html>
<%
	} finally {
