...
<jsp:useBean id="pcBean" class="com.picsauditing.PICS.pqf.CategoryBean"
	scope="page" />
<jsp:useBean id="oBean" class="com.picsauditing.PICS.OSHABean"
	scope="page" />
	...
	if ("Update".equals(request.getParameter("action"))) {
		...
		if ("add".equals(request.getParameter("action"))) {
			request.setAttribute("uploader", String
					.valueOf(com.picsauditing.servlet.upload.UploadProcessorFactory.PREQUAL_OSHA));
...
<table border="0" cellspacing="0" cellpadding="1" class="blueMain">
	...
	<tr align="center">
		<td colspan=2 class="redMain">You must input at least your
		corporate statistics. To further assist your clients, please <br>
		enter additional locations that you maintain OSHA/MSHA logs for that
		may be needed by your clients</td>
	</tr>
	<tr align="center" class="blueMain">
		<td colspan="2">Provide the following numbers (excluding
		subcontractors) using your OSHA/MSHA 300 Forms from the past 3 years:</td>
	</tr>
	...
	<tr align="center">
		...
		<table border="1" cellpadding="5" cellspacing="0"
			...
			<tr>
				<td><nobr><%=oBean.getSHATypeSelect("SHAType", "forms", oBean.SHAType)%>
				Record for location: <%=Inputs.inputSelect("location", "forms", oBean.location, oBean.OSHA_TYPE_ARRAY)%>
				<input name="description" type="text" class="forms"
					value="<%=oBean.description%>" size="17"></nobr></td>
			...
			<tr>
				...
				<td colspan="2"><input name="manHours1" type="text"
					class="forms"
					value="<%=oBean.getStat(oBean.MAN_HOURS, oBean.YEAR1)%>" size="10"></td>
				<td colspan="2"><input name="manHours2" type="text"
					class="forms"
					value="<%=oBean.getStat(oBean.MAN_HOURS, oBean.YEAR2)%>" size="10"></td>
				<td colspan="2"><input name="manHours3" type="text"
					class="forms"
					value="<%=oBean.getStat(oBean.MAN_HOURS, oBean.YEAR3)%>" size="10"></td>
			</tr>
			<tr>
				<td class="redMain">&nbsp;</td>
				<td>No.</td>
			...
			<tr>
				...
				<td><input name="fatalities1" type="text" class="forms"
					value="<%=oBean.getStat(oBean.FATALITIES, oBean.YEAR1)%>" size="4"></td>
				<td><%=oBean.calcRate(oBean.FATALITIES, oBean.YEAR1)%></td>
				<td><input name="fatalities2" type="text" class="forms"
					value="<%=oBean.getStat(oBean.FATALITIES, oBean.YEAR2)%>" size="4"></td>
				<td><%=oBean.calcRate(oBean.FATALITIES, oBean.YEAR2)%></td>
				<td><input name="fatalities3" type="text" class="forms"
					value="<%=oBean.getStat(oBean.FATALITIES, oBean.YEAR3)%>" size="4"></td>
				<td><%=oBean.calcRate(oBean.FATALITIES, oBean.YEAR3)%></td>
			</tr>
			<tr>
				<td class="redMain">Number of Lost Workday Cases - Has lost
				days AND is <%=SHAType%> <%=descriptionText%></td>
				<td><input name="lostWorkCases1" type="text" class="forms"
					value="<%=oBean.getStat(oBean.LOST_WORK_CASES, oBean.YEAR1)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.LOST_WORK_CASES, oBean.YEAR1)%></td>
				<td><input name="lostWorkCases2" class="forms" type="text"
					value="<%=oBean.getStat(oBean.LOST_WORK_CASES, oBean.YEAR2)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.LOST_WORK_CASES, oBean.YEAR2)%></td>
				<td><input name="lostWorkCases3" class="forms" type="text"
					value="<%=oBean.getStat(oBean.LOST_WORK_CASES, oBean.YEAR3)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.LOST_WORK_CASES, oBean.YEAR3)%></td>
			</tr>
			<tr>
				<td class="redMain">Number of Lost Workdays - All lost workdays
				(regardless of restricted days) AND is <%=SHAType%> <%=descriptionText%></td>
				<td><input name="lostWorkDays1" type="text" class="forms"
					value="<%=oBean.getStat(oBean.LOST_WORK_DAYS, oBean.YEAR1)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.LOST_WORK_DAYS, oBean.YEAR1)%></td>
				<td><input name="lostWorkDays2" class="forms" type="text"
					value="<%=oBean.getStat(oBean.LOST_WORK_DAYS, oBean.YEAR2)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.LOST_WORK_DAYS, oBean.YEAR2)%></td>
				<td><input name="lostWorkDays3" class="forms" type="text"
					value="<%=oBean.getStat(oBean.LOST_WORK_DAYS, oBean.YEAR3)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.LOST_WORK_DAYS, oBean.YEAR3)%></td>
			</tr>
			<tr>
				<td class="redMain">Injury & Illnesses Medical Cases - No lost
				OR restricted days AND is <%=SHAType%> <%=descriptionText%>
				(non-fatal)</td>
				<td><input name="injuryIllnessCases1" class="forms" type="text"
					value="<%=oBean.getStat(oBean.INJURY_ILLNESS_CASES, oBean.YEAR1)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.INJURY_ILLNESS_CASES, oBean.YEAR1)%></td>
				<td><input name="injuryIllnessCases2" class="forms" type="text"
					value="<%=oBean.getStat(oBean.INJURY_ILLNESS_CASES, oBean.YEAR2)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.INJURY_ILLNESS_CASES, oBean.YEAR2)%></td>
				<td><input name="injuryIllnessCases3" class="forms" type="text"
					value="<%=oBean.getStat(oBean.INJURY_ILLNESS_CASES, oBean.YEAR3)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.INJURY_ILLNESS_CASES, oBean.YEAR3)%></td>
			</tr>
			<tr>
				<td class="redMain">Restricted Cases - Has restricted days AND
				no lost days AND is <%=SHAType%> <%=descriptionText%></td>
				<td><input name="restrictedWorkCases1" class="forms"
					type="text"
					value="<%=oBean.getStat(oBean.RESTRICTED_WORK_CASES, oBean.YEAR1)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.RESTRICTED_WORK_CASES, oBean.YEAR1)%></td>
				<td><input name="restrictedWorkCases2" class="forms"
					type="text"
					value="<%=oBean.getStat(oBean.RESTRICTED_WORK_CASES, oBean.YEAR2)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.RESTRICTED_WORK_CASES, oBean.YEAR2)%></td>
				<td><input name="restrictedWorkCases3" class="forms"
					type="text"
					value="<%=oBean.getStat(oBean.RESTRICTED_WORK_CASES, oBean.YEAR3)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.RESTRICTED_WORK_CASES, oBean.YEAR3)%></td>
			</tr>
			<tr>
				<td class="redMain">Total <%=SHAType%> <%=descriptionText%>
				Injuries and Illnesses</td>
				<td><input name="recordableTotal1" class="forms" type="text"
					value="<%=oBean.getStat(oBean.RECORDABLE_TOTAL, oBean.YEAR1)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.RECORDABLE_TOTAL, oBean.YEAR1)%></td>
				<td><input name="recordableTotal2" class="forms" type="text"
					value="<%=oBean.getStat(oBean.RECORDABLE_TOTAL, oBean.YEAR2)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.RECORDABLE_TOTAL, oBean.YEAR2)%></td>
				<td><input name="recordableTotal3" class="forms" type="text"
					value="<%=oBean.getStat(oBean.RECORDABLE_TOTAL, oBean.YEAR3)%>"
					size="4"></td>
				<td><%=oBean.calcRate(oBean.RECORDABLE_TOTAL, oBean.YEAR3)%></td>
			</tr>
			<tr>
				<td class="redMain">Were you exempt from submitting OSHA
				Logs?&nbsp;&nbsp;<a href="reasons.html"
					onclick="return popitup('reasons.html')">Valid exemptions</a></td>
			...
			<tr>
				<td align="center" colspan="7"><input name="OID" type="hidden"
					value="<%=oID%>"> <input name="action" type="submit"
					class="forms" value="Update"> <%
 ...
 %>
		...
		<table>
			<tr>
				<td align="left" class="blueMain">Please upload scanned .pdf <%=SHAType%>
				Log Files. If you are unable to do so, you may mail or fax them to
				us and we can scan them for you</td>
			</tr>
		</table>
		<form name="form1" method="post"
		...
		<table border="1" cellpadding="5" cellspacing="0" bordercolor="#FFFFFF" class="redMain">
			...
			<tr>
				...
				<td><input name="osha1_file" type="FILE" class="forms"
					size="15"></td>
				<td align="center"><%=oBean.getFile1YearAgoLink()%></td>
			</tr>
			<tr>
				<td align="right"><%=currentYear - 2%> <%=SHAType%> Logs</td>
				<td><input name="osha2_file" type="FILE" class="forms"
					size="15"></td>
				<td align="center"><%=oBean.getFile2YearAgoLink()%></td>
			</tr>
			<tr>
				<td align="right"><%=currentYear - 3%> <%=SHAType%> Logs</td>
				<td><input name="osha3_file" type="FILE" class="forms"
					size="15"></td>
				<td align="center"><%=oBean.getFile3YearAgoLink()%></td>
			</tr>
			<tr>
				<td colspan="3" align="center"><input name="OID" type="hidden"
					value="<%=oID%>"> <input name="submit" type="submit"
					class="forms" value="Upload Files"></td>
			</tr>
		</table>
		</form>
		</td>
	...
	<tr>
		...
		company. Facilities may request additional regional statistics later.</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td class="buttons">(2)&nbsp;&nbsp; If your company is not
		required to maintain <%=SHAType%> 300 forms, please provide
		information from your Worker&#8217;s Compensation insurance carrier
		itemizing all claims for the last three years.</td>
	</tr>
</table>
</body>
</html>
