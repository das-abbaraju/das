...
grant select, insert, update, delete, drop, execute, create view, trigger on pics_local.* to 'pics_admin'@'%';
grant select, insert, update, delete, drop, execute, create view, trigger on log_archive.* to 'pics_admin'@'%';
grant all on pics_local.* to 'pics'@'%';
grant all on log_archive.* to 'pics'@'%';
grant select on pics_local.* to 'picsro'@'%';
