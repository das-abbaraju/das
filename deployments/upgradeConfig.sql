...
update app_translation set msgValue = 'Informations de compte', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.AccountInformation' and locale = 'fr';
update app_translation set msgValue = 'En cliquant sur Débuter, vous donnez votre accords avec les termes et conditions  <a href="#" class="contractor-agreement modal-link" data-title="Contractor Agreement" data-url="ContractorAgreement.action">PICS Contractor Agreement</a>.', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.AgreeTC' and locale = 'fr';
update app_translation set msgValue = 'Devenez membre de PICS maintenant !', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.BecomeAMember' and locale = 'fr';
update app_translation set msgValue = 'Traduction manquante', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.CompanyDetails.heading' and locale = 'fr';
update app_translation set msgValue = 'Informations sur la compagnie', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.CompanyInformation' and locale = 'fr';
update app_translation set msgValue = 'Contact principal', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.ContactInformation' and locale = 'fr';
update app_translation set msgValue = '16 Pays', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.CountryCount' and locale = 'fr';
update app_translation set msgValue = 'Vous n''êtes qu''à quelques clics de<br />de joindre le réseau d''entrepreneurs <br /> avec la croissance la plus rapide au monde.', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.JoinInfo' and locale = 'fr';
update app_translation set msgValue = 'One fine body…', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.ModalBody' and locale = 'fr';
update app_translation set msgValue = 'Modal Heading', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.ModalHeading' and locale = 'fr';
update app_translation set msgValue = 'Besoin d''aide pour vous enregistrer?', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.NeedHelp' and locale = 'fr';
update app_translation set msgValue = '850 Clients/Opérateurs', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.OperatorCount' and locale = 'fr';
update app_translation set msgValue = 'Compagnies qui utilisent PICS', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.PICSCompanies' and locale = 'fr';
update app_translation set msgValue = 'Se qualifer<br />grâce à PICS', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Qualify' and locale = 'fr';
update app_translation set msgValue = 'Pour toutes questions, écrivez-nous à <a href="#">support@picsauditing.com</a>, appeler nous au (800) 506-PICS (7427) ou clavarder avec l''un de nos représentants.', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Questions' and locale = 'fr';
update app_translation set msgValue = 'Se  préqualifer pour un projet ou un travail', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Reason1' and locale = 'fr';
update app_translation set msgValue = 'Être exposé à plus de clients', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Reason2' and locale = 'fr';
update app_translation set msgValue = 'Prime d''assurance réduite', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Reason3' and locale = 'fr';
update app_translation set msgValue = 'Marketing pour votre compagnie', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Reason4' and locale = 'fr';
update app_translation set msgValue = 'Accès direct à des professionnels de la sécurité', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Reason5' and locale = 'fr';
update app_translation set msgValue = 'Technologie de logiciel simple et puissante', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Reason6' and locale = 'fr';
update app_translation set msgValue = 'Service à la clientèle expert', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Reason7' and locale = 'fr';
update app_translation set msgValue = 'Le Choix des entrepreneurs', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.TheContractorsChoice' and locale = 'fr';
update app_translation set msgValue = '50,000 utilisateurs courants', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.UserCount' and locale = 'fr';
update app_translation set msgValue = 'Pourquoi les entrepreneurs <br />choisissent PICS?', updatedBy = 24143, updateDate = NOW() where msgKey = 'Registration.Why' and locale = 'fr';
