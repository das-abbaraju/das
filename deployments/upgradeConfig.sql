...
-- Updating timezones
update app_translation set msgValue = 'Heure du Pacifique (US / Canada)' WHERE msgKey = 'TimeZone.US.Pacific' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été Magadan (Asie)' WHERE msgKey = 'TimeZone.Asia.Magadan' AND locale = 'fr';
update app_translation set msgValue = 'GMT-12: 00 (GMT +12)' WHERE msgKey = 'TimeZone.Etc.GMT+12' AND locale = 'fr';
update app_translation set msgValue = 'Samoa Heure Normale (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Samoa' AND locale = 'fr';
update app_translation set msgValue = 'Hawaï Standard Time (Honolulu)' WHERE msgKey = 'TimeZone.Pacific.Honolulu' AND locale = 'fr';
update app_translation set msgValue = 'Temps Tahiti (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Tahiti' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée de Hawaii Aléoutiennes (Etats-Unis)' WHERE msgKey = 'TimeZone.US.Aleutian' AND locale = 'fr';
update app_translation set msgValue = 'Alaska Heure Normale (YST9)' WHERE msgKey = 'TimeZone.SystemV.YST9' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée de l''Alaska (États-Unis)' WHERE msgKey = 'TimeZone.US.Alaska' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale des Rocheuses (Arizona)' WHERE msgKey = 'TimeZone.US.Arizona' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée des Rocheuses (USA / Canada)' WHERE msgKey = 'TimeZone.US.Mountain' AND locale = 'fr';
update app_translation set msgValue = 'Heure Normale du Centre (Saskatchewan)' WHERE msgKey = 'TimeZone.Canada.Saskatchewan' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée du Centre (Bahia_Banderas)' WHERE msgKey = 'TimeZone.America.Bahia_Banderas' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée du Centre (US / Canada)' WHERE msgKey = 'TimeZone.US.Central' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de l''est (Port-au-Prince)' WHERE msgKey = 'TimeZone.America.Port-au-Prince' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée de l''est(US / Canada)' WHERE msgKey = 'TimeZone.US.Eastern' AND locale = 'fr';
update app_translation set msgValue = 'Heure du Venezuela  (Caracas)' WHERE msgKey = 'TimeZone.America.Caracas' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Bolivie  (La Paz)' WHERE msgKey = 'TimeZone.America.La_Paz' AND locale = 'fr';
update app_translation set msgValue = 'Heure du Chili Temps (Santiago)' WHERE msgKey = 'TimeZone.America.Santiago' AND locale = 'fr';
update app_translation set msgValue = 'Heure d'' Argentine (Buenos Aires)' WHERE msgKey = 'TimeZone.America.Argentina.Buenos_Aires' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Brasilia  (Sao Paulo)' WHERE msgKey = 'TimeZone.America.Sao_Paulo' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée de Terre-Neuve (Canada)' WHERE msgKey = 'TimeZone.Canada.Newfoundland' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été de l''ouest Groenland (Godthab)' WHERE msgKey = 'TimeZone.America.Godthab' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Fernando de Noronha (DeNoronha)' WHERE msgKey = 'TimeZone.Brazil.DeNoronha' AND locale = 'fr';
update app_translation set msgValue = 'Heure médiane de Greenwich' WHERE msgKey = 'TimeZone.Greenwich' AND locale = 'fr';
update app_translation set msgValue = 'Temps universel coordonné (UTC)' WHERE msgKey = 'TimeZone.Etc.UTC' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été britannique (Londres)' WHERE msgKey = 'TimeZone.Europe.London' AND locale = 'fr';
update app_translation set msgValue = 'Heure de l''Afrique de l''Ouest (Lagos)' WHERE msgKey = 'TimeZone.Africa.Lagos' AND locale = 'fr';
update app_translation set msgValue = 'Heure de l''Afrique de l''Ouest (Windhoek)' WHERE msgKey = 'TimeZone.Africa.Windhoek' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été de l''Europe centrale (Paris)' WHERE msgKey = 'TimeZone.Europe.Paris' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''Europe (Tripoli)' WHERE msgKey = 'TimeZone.Africa.Tripoli' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée d''Israël (Jérusalem)' WHERE msgKey = 'TimeZone.Asia.Jerusalem' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale Saoudite (Riyad)' WHERE msgKey = 'TimeZone.Asia.Riyadh' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée de Moscou (Europe)' WHERE msgKey = 'TimeZone.Europe.Moscow' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée d''Iran (Téhéran)' WHERE msgKey = 'TimeZone.Asia.Tehran' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale du Golfe (Dubaï)' WHERE msgKey = 'TimeZone.Asia.Dubai' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Géorgie (Tbilissi)' WHERE msgKey = 'TimeZone.Asia.Tbilisi' AND locale = 'fr';
update app_translation set msgValue = 'Heure de l''Afghanistan (Kaboul)' WHERE msgKey = 'TimeZone.Asia.Kabul' AND locale = 'fr';
update app_translation set msgValue = 'Heure du Pakistan (Karachi)' WHERE msgKey = 'TimeZone.Asia.Karachi' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de l''Inde (Kolkata)' WHERE msgKey = 'TimeZone.Asia.Kolkata' AND locale = 'fr';
update app_translation set msgValue = 'Heure du Népal (Katmandou)' WHERE msgKey = 'TimeZone.Asia.Kathmandu' AND locale = 'fr';
update app_translation set msgValue = 'Heure du Kirghizstan (Bichkek)' WHERE msgKey = 'TimeZone.Asia.Bishkek' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Alma-Ata (Almaty)' WHERE msgKey = 'TimeZone.Asia.Almaty' AND locale = 'fr';
update app_translation set msgValue = 'Heure du Myanmar (Rangoon)' WHERE msgKey = 'TimeZone.Asia.Rangoon' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''Indochine (Bangkok)' WHERE msgKey = 'TimeZone.Asia.Bangkok' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''Hovd (Asie)' WHERE msgKey = 'TimeZone.Asia.Hovd' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de Chine (Shanghai)' WHERE msgKey = 'TimeZone.Asia.Shanghai' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de l''ouest central (Australie) (Eucla)' WHERE msgKey = 'TimeZone.Australia.Eucla' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été d''Irkoutsk (Asie)' WHERE msgKey = 'TimeZone.Asia.Irkutsk' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale du Japon (Tokyo)' WHERE msgKey = 'TimeZone.Asia.Tokyo' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale du Centre (Northern Territory) (Darwin)' WHERE msgKey = 'TimeZone.Australia.Darwin' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale du Centre (South Australia) (Adelaide)' WHERE msgKey = 'TimeZone.Australia.Adelaide' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de l''est (Queensland) (Brisbane)' WHERE msgKey = 'TimeZone.Australia.Brisbane' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de l''est (Nouvelle-Galles du Sud) (Sydney)' WHERE msgKey = 'TimeZone.Australia.Sydney' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de Lord Howe (Lord_Howe)' WHERE msgKey = 'TimeZone.Australia.Lord_Howe' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Fidji (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Fiji' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de Nouvelle-Zélande (Auckland)' WHERE msgKey = 'TimeZone.Pacific.Auckland' AND locale = 'fr';
update app_translation set msgValue = 'Heure des Marquises (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Marquesas' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de Pitcairn' WHERE msgKey = 'TimeZone.Pacific.Pitcairn' AND locale = 'fr';
update app_translation set msgValue = 'Heure des Galapagos (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Galapagos' AND locale = 'fr';
update app_translation set msgValue = 'Heure de l''Île de Pâques (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Easter' AND locale = 'fr';
update app_translation set msgValue = 'Heure avancée de l''Atlantique (Bermudes)' WHERE msgKey = 'TimeZone.Atlantic.Bermuda' AND locale = 'fr';
update app_translation set msgValue = 'Heure du Cap-Vert (Cape Verde)' WHERE msgKey = 'TimeZone.Atlantic.Cape_Verde' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été des Açores (Atlantique)' WHERE msgKey = 'TimeZone.Atlantic.Azores' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale d''Inde (Colombo)' WHERE msgKey = 'TimeZone.Asia.Colombo' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été de Yakoutsk (Asie)' WHERE msgKey = 'TimeZone.Asia.Yakutsk' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été de Vladivostok (Asie)' WHERE msgKey = 'TimeZone.Asia.Vladivostok' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Pohnpei (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Pohnpei' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Norfolk (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Norfolk' AND locale = 'fr';
update app_translation set msgValue = 'Heure d''été d''Anadyr (Asie)' WHERE msgKey = 'TimeZone.Asia.Anadyr' AND locale = 'fr';
update app_translation set msgValue = 'Heure normale de Chatham (Pacifique)' WHERE msgKey = 'TimeZone.Pacific.Chatham' AND locale = 'fr';
update app_translation set msgValue = 'Heure de Tonga (Tongatapu)' WHERE msgKey = 'TimeZone.Pacific.Tongatapu' AND locale = 'fr';
update app_translation set msgValue = 'Heure de la Ligne Est (Kiritimati)' WHERE msgKey = 'TimeZone.Pacific.Kiritimati' AND locale = 'fr';
--