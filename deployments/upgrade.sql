...
-- PICS-3570
UPDATE `email_template` SET `accountID`='1100', `templateName`='Welcome Email', `subject`='Account Activation', `body`='Dear <ContactName>,\n<br />\n<br />\nYou have created a user account on PICS. Please save the information below for your reference:\n<br />\n<br />\nUsername: <Username>\n<br />\n<br />\nIf you forget your password, please <a href = \"http://www.picsorganizer.com/AccountRecovery.action\">Click Here </a>. \n<br />\n<br />\nPlease Click Here to confirm that you have received this email ${confirmLink}. A separate email will be sent to you to confirm registration once you have completed the process.\n<br />\n<br />\nHave a Great Day!<br />\n<br />\n<CSRName><br />\nPhone <CSRPhone><br />\nFax <CSRFax><br />\n<CSREmail><br />', `createdBy`='941', `creationDate`='2008-09-29 00:00:00', `updatedBy`='38586', `updateDate`='2011-12-14 15:31:01', `listType`='Audit', `allowsVelocity`='1', `html`='1', `recipient`='Admin', `translated`='0'  WHERE (`id` = 2) ;