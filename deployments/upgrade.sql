...
-- PICS-3570
UPDATE `email_template` SET `accountID`='1100', `templateName`='Welcome Email', `subject`='Account Activation', `body`='Dear ${contactName},<br /><br />You have created a user account on PICS. Please save the information below for your reference:<br /><br />Username: ${userName}<br /><br />If you forget your password, please <a href = "http://www.picsorganizer.com/AccountRecovery.action">Click Here </a>.<br /><br />Please <a href=" ${confirmLink}">Click Here</a> to confirm that you have received this email. A separate email will be sent to you to confirm registration once you have completed the process.<br /><br />Thank you,<br />Have a great day!<br />Regards,<br /><br />PICS<br />(949) 387-1940<br />www.picsauditing.com<br />', `createdBy`='941', `creationDate`='2008-09-29 00:00:00', `updatedBy`='38586', `updateDate`='2011-12-14 15:31:01', `listType`='Audit', `allowsVelocity`='1', `html`='1', `recipient`='Admin', `translated`='0'  WHERE (`id` = 2) ;