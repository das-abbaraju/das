...
('email_contractorconfirm_body','Hello %{contact_name},\r\n\r\nYour office audit has been scheduled.Please click the below link to confirm the audit'),
('email_contractorconfirm_subject','Office Audit Confirmation'),
('email_auditorconfirm_subject','Office Audit Confirmation for a contractor'),
('email_auditorconfirm_body','Hello %{contact_name},\r\n\r\nAn office Audit has been scheduled for this contractor.Please click the below link to  confirm the audit');
