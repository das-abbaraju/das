...
alter table `contractor_info` 
	...
	change `billingAmount` `billingAmount` smallint(6)   NULL DEFAULT '0' after `billingCycle`, 
	...
	change `newBillingAmount` `newBillingAmount` smallint(5) unsigned   NULL after `membershipDate`, 
