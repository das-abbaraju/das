...
@Entity(name = "com.picsauditing.security.entities.OperatorAccount")
...
//    private List<ContractorOperator> contractorOperators = new ArrayList<ContractorOperator>();
    private List<OperatorAccount> operatorChildren = new ArrayList<>();
...
//    private List<OperatorCompetency> competencies = new ArrayList<OperatorCompetency>();
    private List<Facility> linkedClients = new ArrayList<>();
    private List<Facility> linkedGeneralContractors = new ArrayList<>();
//
