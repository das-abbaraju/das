...
update token set velocityCode='${contractor.currentCsr.country.csrPhone}' where tokenName='CSRPhone';
update token set velocityCode='${contractor.currentCsr.country.csrFax}' where tokenName='CSRFax';
update token set velocityCode='${contractor.currentCsr.country.csrEmail}' where tokenName='CSREmail';
...
update token set velocityCode='${contractor.currentCsr.country.english}' where tokenName='CSRCountry';

update app_translation set msgValue="${contractor.currentCsr.name}" where msgKey="Token.31.velocityCode";
update app_translation set msgValue="${contractor.currentCsr.country.csrPhone}" where msgKey="Token.32.velocityCode";
update app_translation set msgValue="${contractor.currentCsr.country.csrFax}" where msgKey="Token.34.velocityCode";
update app_translation set msgValue="${contractor.currentCsr.country.csrEmail}" where msgKey="Token.33.velocityCode";
update app_translation set msgValue="${contractor.currentCsr.country.english}" where msgKey="Token.85.velocityCode";
...
update app_translation set msgValue="${contractor.currentInsideSalesRepresentativecountry.isrPhone}" where msgKey="Token.73.velocityCode";
update app_translation set msgValue="${contractor.currentInsideSalesRepresentativecountry.isrFax}" where msgKey="Token.74.velocityCode";
update app_translation set msgValue="${contractor.currentInsideSalesRepresentativecountry.isrEmail}" where msgKey="Token.75.velocityCode";
