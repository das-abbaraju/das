...
class SecurityInformationProviderTest extends BaseTestSetup {
  ...
  trait SecurityDataTest extends DBTest[SecurityInformationProvider] {
    ...
    val findThis = UserData(None, TEST_ACCOUNT_ID, "xx", "Nobody Special", "email", "phone", "fax", true, Some(LATEST_DATE), None)
    val testUser2 = UserData(None, TEST_ACCOUNT_ID, "xx", "Still Nobody Special", "email", "phone", "fax", true, Some(EARLIER_DATE), None)
    val testUser3 = UserData(None, TEST_ACCOUNT_ID, "xx", "Still Nobody Special", "email", "phone", "fax", true, Some(EARLIER_DATE), None)
    val dontFindThis = UserData(None, SOME_OTHER_ID, "xx", "Still Nobody Special", "email", "phone", "fax", true, Some(IMPOSSIBLE_DATE), None)
