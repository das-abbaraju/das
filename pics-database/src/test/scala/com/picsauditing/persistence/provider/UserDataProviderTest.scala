...
class UserDataProviderTest extends BaseTestSetup {
  ...
  trait UserDataTest extends DBTest[UserDataProvider] {
    ...
    val richardPrior = UserData(Some(4L), 9L, "rprior", "Richard Prior", "richard@prior.com", "999-999-9999", "888-888-8888", false, Some(testDate), None)
    val robinWilliams = UserData(Some(0L), 9L, "rwilliams", "Robin Williams", "robin@williams.com", "777-777-7777", "666-666-6666", true, Some(testDate), None)
    val joePeschi = UserData(Some(1L), 5L, "jpeschi", "Joe Peschi", "joe@peschi.com",  "555-555-5555", "444-444-4444", true, Some(testDate), None)
    val georgeCarlin = UserData(Some(2L), 5L, "gcarlin", "George Carlin", "mr_conductor@shiningtimestation.com", "333-333-3333", "222-222-2222", false, Some(testDate), None)
    val samKinison = UserData(Some(3L), 5L, "skinison", "Sam Kinison", "aaaaaaah@marriedforthreeyears.com", "111-111-1111", "000-000-0000", false, Some(testDate), None)
