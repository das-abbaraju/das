<#include "/${parameters.templateDir}/form/start.ftl" />
<#include "/${parameters.templateDir}/form/translate-label.ftl" />
<#--
This is the default struts simple plugin, modified to use i18n on the headerKey and headerValue
-->
...
<#if parameters.headerKey?? && parameters.headerValue??>
    ...
    ><@s.text value="parameters.headerValue"/></option>
</#if>
...
<#include "/${parameters.templateDir}/form/end.ftl" />