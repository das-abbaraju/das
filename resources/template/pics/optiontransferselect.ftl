...
<div class="double-list">
	<div class="double-list-left">
		...
		<#if parameters.allowUpDownOnLeft?default(true)>
			<input type="button" onclick="moveOptionDown(document.getElementById('${parameters.id}'), 'key', <#if parameters.headerKey??>'${parameters.headerKey}'<#else>''</#if>);<#if parameters.upDownOnLeftOnclick?has_content>${parameters.upDownOnLeftOnclick};</#if>"
				<#if parameters.leftDownLabel??>
					value="${parameters.leftDownLabel?html}"
				</#if>
			/>
		
			<input type="button" onclick="moveOptionUp(document.getElementById('${parameters.id}'), 'key', <#if parameters.headerKey??>'${parameters.headerKey}'<#else>''</#if>);<#if parameters.upDownOnLeftOnclick?has_content>${parameters.upDownOnLeftOnclick};</#if>"
	...
	<div class="double-list-right">
		...
		<#if parameters.allowUpDownOnRight?default(true)>
			<input type="button" onclick="moveOptionDown(document.getElementById('${parameters.doubleId}'), 'key', <#if parameters.doubleHeaderKey??>'${parameters.doubleHeaderKey}'<#else>''</#if>);<#if parameters.upDownOnRightOnclick?has_content>${parameters.upDownOnRightOnclick};</#if>"
				<#if parameters.rightDownLabel??>
					value="${parameters.rightDownLabel?html}"
				</#if>
			/>
			
			<input type="button" onclick="moveOptionUp(document.getElementById('${parameters.doubleId}'), 'key', <#if parameters.doubleHeaderKey??>'${parameters.doubleHeaderKey}'<#else>''</#if>);<#if parameters.upDownOnRightOnclick?has_content>${parameters.upDownOnRightOnclick};</#if>"
