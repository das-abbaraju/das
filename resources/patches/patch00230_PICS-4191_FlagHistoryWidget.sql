replace into app_translation (msgKey, locale, msgValue, createdBy, updatedBy, creationDate, updateDate, sourceLanguage, contentDriven)
...
replace into widget (widgetID, caption, widgetType, synchronous, url, chartType) 
