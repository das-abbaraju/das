-- insurance rejection email template
       ...
       <tbody>
        ...
        <tr>
         <td bgcolor="#ffffff" class="content" style="padding:30px 30px 0;background:#ffffff;font-size:15px;color:#333333;">
          <span style="color: rgb(51, 51, 51); font-size: 15px; line-height: 1.5;"><ContactName>,</span><br />
          <br />
...
$caow.notes<br /><br />
        ...
        <tr>
         <td bgcolor="#ffffff" class="signature" style="padding:0 30px 30px;background:#ffffff;font-size:13px;color:#333333;">
          <p>
           <strong><span style="line-height: 1.5;">${permissions.name}</span></strong></p>
          <p>
           PICS Auditing, LLC</p>
          <p style="font-weight:bold;color:#002441;">
           ${contactPhone}<br />
           <a href="mailto:Info@PICSauditing.com" style="color:#002441 !important;text-decoration:none;">${permissions.email}</a></p>
         </td>
        </tr>
       </tbody>
      </table>
