...
public class AccountContractorAuditModelTest {
	...
	public void testAvailableFields() throws Exception {
		...
		assertFalse("contractorPQFExpiresDate was removed", availableFields.containsKey("contractorPQFExpiresDate".toUpperCase()));
		
		assertEquals("OK if close to expected because we added a few fields", 68, availableFields.size());
	}
