...
public class AuditCriteriaAnswerBuilderTest extends TestCase {
	...
	private List<AuditCriteriaAnswer> runner(List<FlagQuestionCriteria> criteriaList, List<AuditData> answerList) {
		AuditCriteriaAnswerBuilder acaBuilder = new AuditCriteriaAnswerBuilder(AuditDataDAO.buildAnswerMapByAudits(answerList), criteriaList);
	...
	private FlagQuestionCriteria newCriteria(FlagColor flagColor, AuditQuestion question, 
			MultiYearScope scope, String comparison, String value) {
