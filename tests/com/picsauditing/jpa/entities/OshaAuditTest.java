...
//		oshaAudit2010.getCategories().add(EntityFactory.addCategories(oshaAudit2010, OshaAudit.CAT_ID_OSHA));
//		oshaAudit2010.getCategories().add(EntityFactory.addCategories(oshaAudit2010, CAT_ID_SOMETHING_OTHER_THAN_OSHA));
//		oshaAudit2010.getCategories().add(EntityFactory.addCategories(oshaAudit2010, OshaAudit.CAT_ID_UK_HSE));
//		
...
//		assertEquals("4.3",oshaAudit2010.getSafetyStatistics(OshaType.OSHA).getStats(OshaRateType.TrirAbsolute));
//		assertEquals("5", oshaAudit2010.getSafetyStatistics(OshaType.OSHA).getStats(OshaRateType.LWCR));
