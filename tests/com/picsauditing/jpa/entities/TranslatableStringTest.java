...
public class TranslatableStringTest {
	// @Test
	// public void testFallback_FallbackFromAmericanToGeneralEnglish() throws
	// Exception {
	// TranslatableString translatableString =
	// EntityFactory.makeEnglishString("button.color", "Color");
	...
	// @Test
	// public void
	// testFallback_FallbackFromAnythingToTheOnlyAvailableTranslation() throws
	// Exception {
	...
	// assertEquals("Zyxxyz",
	// translatableString.toString(Locale.CANADA_FRENCH));
	// }
	// @Test
	// public void testFallback_FallbackFromAnythingToTranslationKey() throws
	// Exception {
	// TranslatableString translatableString = new TranslatableString();
	// translatableString.setKey("button.color");
