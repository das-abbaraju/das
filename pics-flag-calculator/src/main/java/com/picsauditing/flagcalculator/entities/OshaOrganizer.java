...
public class OshaOrganizer implements OshaVisitor {
	...
	Map<OshaType, Map<Integer, SafetyStatistics>> safetyStatisticsData = new HashMap<>();
...
//	}
//
	private BigDecimal getRateForSpecificYear(OshaType type, Integer year, OshaRateType rateType) {
		if (year != null) {
