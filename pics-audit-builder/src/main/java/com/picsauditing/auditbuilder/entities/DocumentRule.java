...
@MappedSuperclass
public class DocumentRule extends BaseDecisionTreeRule {
	...
	protected DocumentStatus dependentDocumentStatus;
	private PastDocumentYear yearToCheck;
	...
	public boolean isMoreSpecific(DocumentRule o) {
		if (o == null)
			return true;
		if (this.equals(o))
			return false;
	...
	public void setDependentDocumentStatus(DocumentStatus dependentDocumentStatus) {
	...
	@Type(type = "com.picsauditing.auditbuilder.entities.EnumMapperWithEmptyStrings", parameters = {
			@Parameter(name = "enumClass", value = "com.picsauditing.auditbuilder.entities.PastDocumentYear"),
			@Parameter(name = "identifierMethod", value = "getDbValue"),
			@Parameter(name = "valueOfMethod", value = "fromDbValue")})
	public PastDocumentYear getYearToCheck() {
		return yearToCheck;
	}

	public void setYearToCheck(PastDocumentYear yearToCheck) {
		this.yearToCheck = yearToCheck;
	}

	public boolean appliesToASpecificYear() {
		return yearToCheck != PastDocumentYear.Any;
	}
}