...
import com.picsauditing.auditbuilder.entities.DocumentStatus;
...
public class DocumentPeriodService {
    public boolean shouldCreateAudit(List<ContractorDocument> audits, AuditType auditType, String auditFor, AuditType childAuditType) {
        ...
        for (String childAuditFor: childAuditFors) {
            for (ContractorDocument audit : audits) {
                if (childAuditType.equals(audit.getAuditType()) && childAuditFor.equals(audit.getAuditFor()) && DocumentUtilityService.hasCaoStatusBefore(audit, DocumentStatus.NotApplicable)) {
                    return true;
                }
            }
        }
    ...
    public ContractorDocument findAudit(List<ContractorDocument> audits, AuditType auditType, String auditFor) {
        for (ContractorDocument audit:audits) {
