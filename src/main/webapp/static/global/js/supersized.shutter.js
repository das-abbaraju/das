	 	...
	 	beforeAnimation : function(direction){
            ...
            switch (slideTitle){
               ...
               break;
                ...
                case "lake" :
                      var html = '<p class="header-text">'+
                                    'By building your KRYSTALARK&reg;, you insure your loved ones, and yourself, that you will always be in their life.'+
                                 '</p> '
                ...
                case "kid" :
                     var html = '<p class="header-text">'+
                       'You are given a free online safe deposit box which is encrypted and can  '+
                       'only be retrieved by loved ones of your choosing. Even we cannot view or open it. '+
                   '</p> '
