...
CREATE PROCEDURE	[dbo].[gspRole_Resource_RightType]
(
...
,	@Resrc_id		udtResrc_id	=  -2147483647	-- PK3 AK3
,	@Resrc_tp		udtResrc_tp	= '-2147483647'	-- PK4 AK4
,	@Resrc_nm		udtResrc_nm	= '-2147483647'	--  AK6
,	@Right_tp		udtResrc_tp	= '-2147483647'	-- PK5 AK5
...
AS
/*
**	Name:		gspRole_Resource_RightType
...
BEGIN
	...
	SELECT
 		@STATUS		= 0
	,	@RETURN		= 0
	,	@SYSTABLE	= 'vwRole_Resource_RightType'
	,	@SYSRIGHT	= 'SELECT'
