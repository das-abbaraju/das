...
public enum OpPerms {
	...
	DevelopmentEnvironment("Development Environment", "Allow PICS employees to test.", true, true),
	...
	RiskRank("Edit Contractor Risk Level", "Allows PICS users to manually edit the contractor's Risk Level.", true, true),
	...
	FormsAndDocs("Manage Forms and Docs", "Allow users to Edit and Delete Forms and Documents. Edit is required to Add or Update forms. Delete is required to delete forms.", true, true),
	...
	EditNotes("Contractor Notes", "Allows users to add notes to a contractor's account. Allows Users to view/add/edit/delete notes.", true, true),
	...
	// Account Management
	ManageOperators("Manage Operator Accounts", "Allows PICS employees to view/edit/delete Operator accounts", true, true),
	EmailOperators("Send Operator Emails", "Allows PICS employees to send emails to operators accounts", false, false),
	ManageCorporate("Manage Corporate Accounts", "Allows PICS employees to view/edit/delete Corporate accounts", true, true),
	ContractorAccounts("Administer Contractor Accounts", "Allow PICS employees to create/update/delete contractor accounts", true, true),
	ContractorActivation("Activate Contractor Accounts", "Allow PICS employees to view/activate/remove contractor accounts during the activation phase", true, true),
	EditUsers("Manage User Accounts", "Allows administrators to view/add/update/delete users for their account", true, true),
	ChangePassword("Change User Password", "Allows administrators to change passwords on user accounts", true, true),
	...
	AuditEdit("Contractor Audit (System)", "Can view and edit all fields related to an audit", true, true),
	AuditCopy("Audit Copy", "Can Copy Audit from one Contractor to another Contractor", false, false),
	MyCalendar("My Calendar", "View and Edit your Calendar", true, true),
	Holidays("Holidays", "Manage the Holiday schedule for PICS", false, false),
	ManageCalendars("Manage Auditor Calendars", "Allows user to edit all auditor calendars", true, true),

	// Insurance
	InsuranceCerts("Insurance Certificates", "Allows users to view (Read), upload (Edit), and delete insurance certificates", true, true),
	...
	InvoiceEdit("Edit Invoice", "Can view and edit all fields related to an invoice", true, true),

	ContractorTags("Contractor Tags", "Allow operators to tag and categorize their contractors into searchable groups.", true, true),
	...
	EmailTemplates("Email Templates", "Allows PICS employees to edit the templates used to automatically send emails", true, true),
	...
	ManageWebcam("Webcam Management", "Can view and edit PICS' inventory of web cameras", true, true),
	AuditorPayments("Auditor Payments", "Create and manage independent contractor payments for audits.", true, true),

	// Manage User Account Roles
	UserRolePicsOperator("User Roles PICS Operator", "Allow PICS users to assign the users to a Role.", true, true),
	...
	// OpPerms(String desc, String help, boolean edit, boolean delete, boolean
	// admin, boolean con, boolean op) {
