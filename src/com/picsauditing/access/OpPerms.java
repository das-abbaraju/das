...
public enum OpPerms {
	...
	ViewTrialAccounts("View Listed Contractors", "Allows users to approve or reject contractors who are bidding for work at their facility.", true, false, true, false, true),
