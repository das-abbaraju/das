...
public enum OpPerms {
	...
	ViewTrialAccounts("View List Only Contractors", "Allows users to approve or reject contractors who are bidding for work at their facility.", true, false, true, false, true),
