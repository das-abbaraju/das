...
public class User extends AbstractIndexableTable implements java.io.Serializable, Comparable<User>, JSONable {
    ...
    /**
     * @param permissions  The new set of permission for this user (transient version of
     *                     user.permissions)
     * @param connectPerm  The actual UserAccess object owned by either the current user
