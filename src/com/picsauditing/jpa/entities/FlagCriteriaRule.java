...
@Entity
@Table(name = "flag_criteria_rule")
public class FlagCriteriaRule extends BaseDecisionTreeRule {

	protected FlagCriteria criteria;
	protected FlagColor flag = FlagColor.Red;
	protected String hurdle;
	 ...
	 * @return
	 */
	public boolean isMoreSpecific(FlagCriteriaRule o) {
		if (o == null)
			return true;
		if (this.equals(o))
			return false;
