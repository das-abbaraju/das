...
public class TranslatableString implements Comparable<TranslatableString>, Serializable {
	...
	// }
	//
	// public void putTranslation(String locale, String translation, boolean
	// insert) {
	...
	/*
	 * public boolean isExists() { String translation = toString();
	 * 
	 ...
	 * !translation.toLowerCase().equals(I18nCache
	 * .DEFAULT_TRANSLATION.toLowerCase()) && !translation.equals(key); }
	 */
	...
	public String getStripTags() {
		return Utilities.stripTags(toString());
	}
