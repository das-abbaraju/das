...
public class ModelChangeListenerList<T extends IsSerializable> implements
		IsSerializable {
	...
	public void fireChangeEvent() {
		ArrayList<ModelChangeListener<T>> copy = (ArrayList<ModelChangeListener<T>>) listeners
				.clone();
