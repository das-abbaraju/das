...
"Rwanda","Saint Helena","Saint Kitts and Nevis","Saint Lucia","Saint Pierre and Miquelon","Saint Vincent and the Grenadines","Samoa","San Marino","Sao Tome and Principe","Saudi Arabia","Senegal","Seychelles","Sierra Leone","Singapore","Slovak Republic","Slovenia","Solomon Islands","Somalia","South Africa","South Georgia and the South Sandwich Islands","Spain","Sri Lanka","Sudan","Suriname",
"Svalbard and Jan Mayen Islands","Swaziland","Sweden","Switzerland","Syria","Taiwan","Tajikistan","Tanzania","Thailand","Togo","Tokelau","Tonga","Trinidad and Tobego","Tunisia","Turkey","Turkmenistan","Turks and Caicos Islands","Tuvalu","Uganda","Ukraine","United Arab Emirates","United Kingdom","Uruguay","USA","Uzbekistan","Vanuatu","Vatican City",
"Venezuela","Vietnam","Virgin Islands (British)","Virgin Islands (US)","Wallis and Futuna Islands","Western Sahara","Yemen","Yugoslavia","Zaire","Zambia","Zimbabwe"};
	...
	static final String[] STATE_ARRAY = {"AL", "Alabama",
							"AK", "Alaska",
							"AZ", "Arizona",
							"AR", "Arkansas",
							"CA", "California",
...
//	}//getStateSelect
	...
	public static String escapeHTML(String value) { 
		...
		//BJ 2-21-05 java can not reccognize ms apostrpohes, so must work backwards
		//loop through to find where ms apostrpohes were converted to question marks, change to standard apostrophes
...
//		strval.replace(substart,substart+3,"'");
	...
	public static String escapeQuotes(String value) { 
		...
		for (int i = 0; i < value.length(); i++) { 
			...
			if ((ch == 146) || (ch == '\'') || (ch == '%')) 
				strval.append("''");
			//if find double quote, change to single quote since html input can't handle double quotes BJ 3-7-05
			else if (ch==92)
				strval.append("\\\\");
			else if (ch=='"')
				strval.append("''");
	...
	public static String getMenuTag(HttpServletRequest req, String thisLink, String thisPage, String id, String queryString, String thisQuery, String title) {
		...
		return "<a class=blueMain href="+thisLink+"?"+queryString+">"+title+"</a>";
	}//getMenuTag

	public static String getBGColor(int count) {
		if ((count % 2) == 0)	return " bgcolor=\"#FFFFFF\"";
		else	return "";
	}//getBGColor
	...
	public static String getRadioInput(String name, String classType, String selected, String[] optionsArray) {
		...
		while (li.hasNext()) {
			String option=(String)li.next();
			temp.append("<input name=").append(name).append(" class=").append(classType);
	...
	public static String printRequest(javax.servlet.http.HttpServletRequest request){
