...
public class ReportCsrAssignmentStats extends ReportAccount {
	...
	public String execute() throws SQLException {
		String sql = "select \r\n"
                ...
                + "  join account_user au ON au.accountID = c.id AND au.role = 'PICSCustomerServiceRep' AND au.startDate < NOW() AND au.endDate > NOW()\r\n"
				+ "  where a.status = 'Active'\r\n"
				+ "  and a.type = 'Contractor'\r\n"
				+ "  and au.userID = u.id\r\n"
				+ "  and exists(\r\n"
				+ "    select * from contractor_fee cf\r\n"
				+ "    where cf.conID = c.id\r\n"
				+ "    and (cf.currentAmount > 0 or cf.newAmount > 0)\r\n"
				+ "    and cf.feeClass = 'AuditGUARD'\r\n"
				+ "    )\r\n"
