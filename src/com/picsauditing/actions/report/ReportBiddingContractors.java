	...
	public String execute() throws Exception {
		...
		if (button != null) {
			...
			if ("Upgrade".equals(button)) {
				...
				summary = "Upgraded and Approved the List Only Account for " + permissions.getAccountName()
			...
			if ("Reject".equals(button)) {
				...
				summary = "Rejected Contractor for the List Only Account for " + permissions.getAccountName();
			}
