...
public class AuditAnalyzer extends Analyzer {
	...
	private SelectSQL buildQueryForAuditsCreatedInLeftNotCreatedInRight() {
		...
		selectSQL.addJoin("LEFT JOIN "+rightDatabase+".contractor_audit ca2 on ca2.auditTypeID = ca1.auditTypeID and ca2.conID = ca1.conID");
	...
	private SelectSQL buildQueryForCAOsCreatedInLeftNotCreatedInRight() {
		...
		selectSQL.addJoin("LEFT JOIN ("+innerSelect.toString()+") ca3 on ca3.auditTypeID = ca1.auditTypeID and ca3.conID = ca1.conID");
