...
public class FileUtils {
	 ...
	 * 
	 * @param f file handle for the file we want to copy
	 * @param root The FTP-DIR from web context
	 * @param partialPath remaining part of the file path to put file into
	 * @param deleteDuplicates
	 *            Set to true if you want to remove files with the same name but different extensions
	 * @return
	 */
	static public void copyFile(File f, String ftpDir, String partialPath, String fileName, String extension, boolean deleteDuplicates) throws Exception {
