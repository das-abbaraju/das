...
public class ForcedFlagsSubscription extends SubscriptionBuilder {

	protected Report report = new Report();
	protected List<BasicDynaBean> data;

	public ForcedFlagsSubscription(SubscriptionTimePeriod timePeriod, EmailSubscriptionDAO subscriptionDAO) {
		super(Subscription.ForcedFlags, timePeriod, subscriptionDAO);
		this.templateID = 165;
	}
