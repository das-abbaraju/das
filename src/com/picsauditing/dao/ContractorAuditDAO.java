...
public class ContractorAuditDAO extends PicsDAO {
	...
	public List<ContractorAudit> findNew(int limit, Permissions permissions) {
		...
		return findWhere(limit, "auditStatus IN ('Pending', 'Submitted') " + permQuery.toString()
				+ getAuditWhere(permissions), "createdDate DESC");
	}
	...
	public ContractorAudit addPending(AuditType auditType, ContractorAccount contractor, String auditFor, Date startDate) {
