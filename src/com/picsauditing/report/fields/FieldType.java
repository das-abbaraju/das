...
public enum FieldType {
	...
	AccountLevel(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	AccountStatus(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	AccountType(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	AccountUser(FilterType.Autocomplete, DisplayType.String, SqlFunctionProfile.String, null),
	ApprovalStatus(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	AuditStatus(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	AuditSubStatus(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	AuditType(FilterType.Autocomplete, DisplayType.String, SqlFunctionProfile.String, null),
	AuditTypeClass(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	...
	ContractorOperatorNumberType(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	...
	Currency(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	...
	OshaRateType(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	OshaType(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	PaymentMethod(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	...
	TransactionStatus(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	UserAccountRole(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.STRING),
	UserID(FilterType.UserID, DisplayType.Number, SqlFunctionProfile.Boolean, null),
	WaitingOn(FilterType.ShortList, DisplayType.String, SqlFunctionProfile.String, EnumType.ORDINAL);
