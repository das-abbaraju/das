...
public class ArrayOfString implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name = ArrayOfString Namespace URI =
	 * http://developer.intuit.com/ Namespace Prefix = ns1
	 */
		...
		public static ArrayOfString parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ArrayOfString".equals(type)) {
							...
							return (ArrayOfString) com.intuit.developer.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://developer.intuit.com/", "string").equals(reader
								.getName())) {
					...
					while (!loopDone1) {
						...
						if (reader.isEndElement()) {
							...
							if (new javax.xml.namespace.QName("http://developer.intuit.com/", "string").equals(reader
									.getName())) {
