...
public class UpdatePayments extends CustomerAdaptor {
	...
	public Object parseQbXml(QBSession currentSession, String qbXml) throws Exception {
		...
		//		
		// List<Object> hostQueryRsOrCompanyQueryRsOrCompanyActivityQueryRs =
		// msgsRs.getHostQueryRsOrCompanyQueryRsOrCompanyActivityQueryRs();
		//		
		...
		//
		// int invoiceId = new Integer(
		// currentSession.getCurrentBatch().get(thisQueryResponse.getRequestID())).intValue();
		//			
