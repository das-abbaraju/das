...
public class GetContractorsForUpdate extends CustomerAdaptor {
	...
	public String getQbXml(QBSession currentSession) throws Exception {
		...
		List<ContractorAccount> contractors = getContractorDao().findWhere("a.qbListID is not null and a.qbSync = true and a.mustPay = 'Yes'");
	...
	public Object parseQbXml(QBSession currentSession, String qbXml)
		...
		for( String listId : parsedResponses.keySet() ) {
			...
			if( contractor != null && contractor.getId() != 0 && currentSession.getPossibleUpdates().contains(contractor)) {
