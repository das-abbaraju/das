...
public class SendRequestXML implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://developer.intuit.com/", "sendRequestXML", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (localQbXMLMajorVers == java.lang.Integer.MIN_VALUE) {
			...
			xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localQbXMLMajorVers));
		}
		...
		if (localQbXMLMinorVers == java.lang.Integer.MIN_VALUE) {
			...
			xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localQbXMLMinorVers));
		}
		...
		if (localStrCompanyFileNameTracker) {
			...
			if (localStrCompanyFileName != null) {
				elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
						.convertToString(localStrCompanyFileName));
			} else {
				throw new org.apache.axis2.databinding.ADBException("strCompanyFileName cannot be null!!");
			}
		}
		...
		public static SendRequestXML parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"sendRequestXML".equals(type)) {
							...
							return (SendRequestXML) com.intuit.developer.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://developer.intuit.com/", "ticket").equals(reader
								.getName())) {
				...
				if (reader.isStartElement()
					...
					object.setStrCompanyFileName(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://developer.intuit.com/", "qbXMLCountry").equals(reader
								.getName())) {
