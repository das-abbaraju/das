...
public class AccountServiceFactory {
	...
	public static AccountService getAccountService() {
		...
		AccountModel operator = new AccountModel.Builder().id(Account.PICS_ID).accountType(AccountType.OPERATOR).name("Operator").build();
		...
		when(accountService.getChildOperatorIds(anyInt())).thenReturn(Arrays.asList(Account.PICS_ID));
