...
public class UserManagerTest {
	...
	public void testInitializeNewUser_SetsIsGroupToNo() throws Exception {
		...
		when(appUserService.generateNewAppUser(any(String.class), any(String.class))).thenThrow(new RuntimeException());
		when(appUserDAO.findById(any(Integer.class))).thenReturn(appUser);
