...
public class ReportCompetencyByEmployee extends ReportEmployee {
	...
	protected void addExcelColumns() {
		...
		excelSheet.addColumn(new ExcelColumn("roles", getText("ReportCompetencyByEmployee.label.JobRoles")));
		excelSheet.addColumn(new ExcelColumn("skilled", getText("ReportCompetencyByEmployee.label.Competency"),
				ExcelCellType.Integer));
		excelSheet.addColumn(new ExcelColumn("required", getText("ReportCompetencyByEmployee.label.Required"),
				ExcelCellType.Integer));
		excelSheet.addColumn(new ExcelColumn("percent", getText("ReportCompetencyByEmployee.label.Competency") + " %",
				ExcelCellType.Integer));
	}
}
