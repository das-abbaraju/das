...
public class MovePendingAccountsToDeclined extends CronTask {
    ...
    public MovePendingAccountsToDeclined(ContractorAccountDAO contractorAccountDAO, AccountStatusChanges accountStatusChanges) {
        super(NAME);
