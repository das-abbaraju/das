...
public final class ProjectAssignmentProcess {
	...
	public static Map<Role, Set<Employee>> getCorporateRoleEmployees(final Map<Role, Set<Employee>> projectEmployees,
	...
	private static Map<Role, Set<Employee>> mapSiteRolesToCorporateRoles(final Map<Role, Set<Employee>> siteRoleEmployees,
																		 final Map<Role, Role> siteToCorporateRoles) {
