...
public class SkillFactory {
	...
	public static Skill create(final AccountSkill accountSkill, final AccountSkillProfile accountSkillProfile) {
		...
		return new Skill.Builder()
				...
				.name(accountSkill.getName())
				.skillType(accountSkill.getSkillType())
				.skillStatus(calculateSkillStatus(accountSkillProfile))
				.endDate(accountSkillProfile.getEndDate())
				.build();
	}

	private static SkillStatus calculateSkillStatus(final AccountSkillProfile accountSkillProfile) {
