...
public enum OpPerms implements Translatable {
	...
	RiskRank("Edit Contractor Risk Level", "Allows PICS users to manually edit the contractor's Risk Level.", true, false, false, false, false),
	...
	EditContractorSafeHarbor("Edit Contractor Safe Harbor options", "Allows users to view/edit the 'Automatically Add My Account.' option.", true, false, true, false, false),
	...
	Translator("Translator", "Allow users translate PICS Organizer", true, true, true, false, false),
	...
	ViewTrialAccounts("View Bid Only Contractors", "Allows users to approve or reject contractors who are bidding for work at their facility.", true, false, true, false, true),
	...
	// Account Management
    ManageOperatorConfig("Manage Client Configuration", "Allow PICS employees to copy operator configurations", true, true, true, false, false),
    ...
    ClientAuditEdit("Contractor Audit (Client)", "Client can view and edit all fields related to an audit", true, true, true, false, true),
	...
	AuditRuleAdmin("Audit Rule Admin", "Allows user to Administer Rules created or modified by other users", true, false, false, false, false),
    ...
    EditTags("Edit Tags", "Allow users to edit/update/remove tags and assign/unassign tags to contractors.", true, true, true, false, true),
	...
	UploadEmployeeDocumentation("Upload Employee Documentation", "Allows operators to upload documentation for " +
			"employees.", false, true, true, false, true),
