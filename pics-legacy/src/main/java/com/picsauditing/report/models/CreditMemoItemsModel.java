...
public class CreditMemoItemsModel extends AbstractModel {

	public CreditMemoItemsModel(Permissions permissions) {
		super(permissions, new CreditMemoItemTable());
	}

	public ModelSpec getJoinSpec() {
		ModelSpec spec = new ModelSpec(null, "CreditMemoItem");
        spec.join(CreditMemoItemTable.Fee);

        ModelSpec invoice = spec.join(CreditMemoItemTable.CreditMemo);
        invoice.alias = "CreditMemo";
