...
public class ItalyStatistics extends SafetyStatistics {

	public static final int QUESTION_ID_IR_FOR_THE_GIVEN_YEAR = 17121;
	public static final int QUESTION_ID_AFR_FOR_THE_GIVEN_YEAR = 17120;
	public static final int QUESTION_ID_FATALITIES_FOR_THE_GIVEN_YEAR = 17112;
	public static final int QUESTION_ID_HOURS_FOR_THE_GIVEN_YEAR = 17108;

	public ItalyStatistics(int year, List<AuditData> data, boolean categoryApplies) {
		super(year, OshaType.ITALY, data);
