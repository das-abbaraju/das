...
public class AutocompleteDAO {
	...
	private static final String FIND_USERS_AND_GROUPS = "SELECT IF(u.isGroup = 'YES', 'group', 'user') type, " +
			"u.id, u.name, '' AS 'city', '' AS 'countrySubdivision', a.name AS 'userLocation', " +
	...
	private static final String FIND_ACCOUNTS = "SELECT 'account' type, a.id, a.name, " +
			"a.city AS 'city', a.countrySubdivision AS 'countrySubdivision', '' AS 'userLocation', a.type 'resultCategory', NULL isGroup, a.id accountID " +
			"FROM accounts a " +
