...
public class ConnectionError implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://developer.intuit.com/", "connectionError", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName, final org.apache.axiom.om.OMFactory factory,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "connectionError", xmlWriter);
			}
	...
	public static class Factory {
		...
		public static ConnectionError parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"connectionError".equals(type)) {
							...
							return (ConnectionError) com.intuit.developer.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://developer.intuit.com/", "hresult").equals(reader
								.getName())) {
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://developer.intuit.com/", "message").equals(reader
								.getName())) {
