...
public class ReceiveResponseXML implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://developer.intuit.com/", "receiveResponseXML", "ns1");
	...
	public static class Factory {
		...
		public static ReceiveResponseXML parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"receiveResponseXML".equals(type)) {
							...
							return (ReceiveResponseXML) com.intuit.developer.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
						&& new javax.xml.namespace.QName("http://developer.intuit.com/", "response").equals(reader
								.getName())) {
