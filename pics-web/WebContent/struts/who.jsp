...
<s:text name="WhoIs.TaggedBy"><s:param><s:property value="#o.updatedBy.name"/></s:param><s:param><s:property value="#o.updatedBy.account.name"/></s:param><s:param><s:date name="#o.updateDate" format="%{@com.picsauditing.util.PicsDateFormat@Datetime}" /></s:param></s:text>
