...
<s:url action="NewContractorSearchCSV" var="download_results_excel">
    <s:param name="button">download</s:param>
</s:url>
	...
	<s:else>
        <pics:permission perm="ContractorDetails">
            <s:if test="!filter.allowMailMerge">
            	<div class="right">
                    <a
                        class="excel download-search-results"
                		href="#"
                        data-url="${download_results_excel}"
                		data-number-of-results="${report.allRows}"
