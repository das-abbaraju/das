...
<head>
    ...
    <script type="text/javascript">
        ...
        function openAddNote() {
            window.open('NoteEditor.action?id=<s:property value="id"/>&note=0&mode=edit&embedded=0&note.noteCategory=Audits&note.canContractorView=true','name','toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=770,height=550');
        }
