...
This is a description of the convention
    </s:param>

    <%-- The value of accordian_parent_id should be {section-id-prefix}-{file name} --%>
    <s:param name="accordian_parent_id">template-section-best-practices-2</s:param>

    <s:param name="example_code">
This is an example implementation of the convention
    </s:param>
</s:include>