...
<tw:form formName="operator_project_roles_edit" action="${operator_project_roles_edit_url}" method="post"
    ...
    <fieldset>
        <div class="form-group">
            <tw:label labelName="roles" class="col-md-3 control-label"><s:text name="OPERATOR.PROJECT.PROJECT_JOB_ROLES.EDIT.JOB_ROLES.LABEL"/></tw:label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <div class="col-md-9 col-md-offset-3 form-actions">
                <tw:button buttonName="save" type="submit" class="btn btn-success" tabindex="2"><s:text name="OPERATOR.PROJECT.PROJECT_JOB_ROLES.EDIT.SAVE.BUTTON"/></tw:button>
                <tw:button buttonName="cancel" type="button" class="btn btn-default cancel" tabindex="3"><s:text name="OPERATOR.PROJECT.PROJECT_JOB_ROLES.EDIT.CANCEL.BUTTON"/></tw:button>
            </div>
        </div>
    </fieldset>
</tw:form>