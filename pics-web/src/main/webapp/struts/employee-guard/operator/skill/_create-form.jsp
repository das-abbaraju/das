...
<tw:form formName="operator_skill_create" action="${operator_skill_create_url}" method="post" class="form-horizontal js-validation" role="form">
    <fieldset>
        <div class="form-group">
            <tw:label labelName="name" class="col-md-3 control-label"><strong><s:text name="CORPORATE.SKILLS.ADD.NAME"/></strong></tw:label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <tw:label labelName="description" class="col-md-3 control-label"><s:text name="CORPORATE.SKILLS.ADD.DESCRIPTION"/></tw:label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <tw:label labelName="skillType" class="col-md-3 control-label"><strong><s:text name="CORPORATE.SKILLS.ADD.SKILL_TYPE"/></strong></tw:label>
        ...
        <div class="form-group">
            <tw:label labelName="groups" class="col-md-3 control-label"><s:text name="CORPORATE.SKILLS.ADD.JOB_ROLES"/></tw:label>
            <div class="col-md-4">
            ...
            <div class="col-md-4 col-md-offset-3">
                <div classs="checkbox">
                    <tw:label labelName="addAnother" class="control-label">
                        <tw:input inputName="addAnother" type="checkbox" value="true" tabindex="9" /> <s:text name="CORPORATE.SKILLS.ADD.ADD_ANOTHER.CHECKBOX"/>
                    </tw:label>
                </div>
            </div>

            <div class="col-md-9 col-md-offset-3 form-actions">
                <tw:button buttonName="save" type="submit" class="btn btn-success" tabindex="10" ><s:text name="CORPORATE.SKILLS.ADD.ADD.BUTTON"/></tw:button>
                <a href="${operator_skill_list_url}" class="btn btn-default" tabindex="11" ><s:text name="CORPORATE.SKILLS.ADD.CANCEL.BUTTON"/></a>
            </div>
        </div>
    </fieldset>
</tw:form>