  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><s:text name="EMPLOYEE.UNASSIGN.CONFIRMATION.CANCEL" /></button>
        <button class="btn btn-warning unassign"><s:text name="EMPLOYEE.UNASSIGN.CONFIRMATION.UNASSIGN" /></button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
