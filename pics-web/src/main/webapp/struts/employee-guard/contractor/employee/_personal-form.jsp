...
<tw:form formName="contractor_employee_edit_personal" action="${contractor_employee_edit_url}" method="post" class="form-horizontal js-validation" autocomplete="off" role="form">
    <div class="form-group ${first_name_error_class}">
        <tw:label labelName="firstName" class="col-md-3 control-label"><strong><s:text name="EMPLOYEE.PERSONAL.FIRST_NAME" /></strong></tw:label>
        <div class="col-md-4">
    ...
    <div class="form-group ${last_name_error_class}">
        <tw:label labelName="lastName" class="col-md-3 control-label"><strong><s:text name="EMPLOYEE.PERSONAL.LAST_NAME" /></strong></tw:label>
        <div class="col-md-4">
    ...
    <div class="form-group ${email_error_class}">
        <tw:label labelName="email" class="col-md-3 control-label"><strong><s:text name="EMPLOYEE.PERSONAL.EMAIL" /></strong></tw:label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <tw:label labelName="phoneNumber" class="col-md-3 control-label"><s:text name="EMPLOYEE.PERSONAL.PHONE" /></tw:label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <div class="col-md-9 col-md-offset-3 form-actions">
            <tw:button buttonName="save" type="submit" class="btn btn-success" tabindex="5"><s:text name="EMPLOYEE.PERSONAL.SAVE" /></tw:button>
            <tw:button buttonName="cancel" type="button" class="btn btn-default cancel" tabindex="6"><s:text name="EMPLOYEE.PERSONAL.CANCEL" /></tw:button>
        </div>
    </div>
</tw:form>