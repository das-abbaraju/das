...
<tw:form formName="contractor_employee_edit_employment" action="${contractor_employee_edit_url}" method="post" class="form-horizontal js-validation" autocomplete="off" role="form">
    <div class="form-group">
        <tw:label labelName="employeeId" class="col-md-3 control-label"><s:text name="CONTRACTOR.EMPLOYEE.EMPLOYMENT.EMPLOYEE_ID" /></tw:label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <tw:label labelName="title" class="col-md-3 control-label"><s:text name="CONTRACTOR.EMPLOYEE.EMPLOYMENT.TITLE" /></tw:label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <tw:label labelName="groups" class="col-md-3 control-label"><s:text name="CONTRACTOR.EMPLOYEE.EMPLOYMENT.GROUPS" /></tw:label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <div class="col-md-9 col-md-offset-3 form-actions">
            <tw:button buttonName="save" type="submit" class="btn btn-success" tabindex="4"><s:text name="CONTRACTOR.EMPLOYEE.EMPLOYMENT.SAVE" /></tw:button>
            <tw:button buttonName="cancel" type="button" class="btn btn-default cancel" tabindex="5"><s:text name="CONTRACTOR.EMPLOYEE.EMPLOYMENT.CANCEL" /></tw:button>
        </div>
    </div>
</tw:form>