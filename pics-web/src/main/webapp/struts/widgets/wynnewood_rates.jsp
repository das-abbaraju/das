		...
		<tr>
			...
			<td class="center" width="5">
				<s:if test="contractRates.get(#key) != null">
					<a href="Audit.action?auditID=<s:property value="contractRates.get(#key).id" />">Rate</a>
				</s:if>
				<s:else>
					No Rate
				</s:else>
			</td>
			<td class="center" width="5"><a href="Audit.action?auditID=<s:property value="id" />">Contract</a></td>
		</tr>
	</s:iterator>
	</s:else>
</table>