		...
		<ul id="navlist">
			...
			<li>
                <s:if test="permissions.usingVersion7Menus">
                    <a href='Report.action?report=1&dynamicParameters=[{"value":"<s:property value="operator.id"/>","field_id":"ContractorWorksAtClientSite","operator":"In"}]' id="v7_facilitiesedit_contractor">
                </s:if>
                <s:else>
