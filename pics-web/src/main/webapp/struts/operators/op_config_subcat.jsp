...
<ol class="subcat-list" id="subcat_<s:property value="#subcat.id" />">
	<s:iterator value="#subcat.subCategories" id="subcat">
		<li>
			<a href="#" onclick="return loadCatRules(<s:property value="#subcat.id" />, <s:property value="#parentCatID" />, '<s:property value="#subcat.name" />');"><s:property value="#subcat.name" /></a>
