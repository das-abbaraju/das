...
(function( $ ) {
	...
	//	Keeps track of current level in menu
	var menu_level = 0;
...
//		pageNode	: null,
	...
	*/
	...
	function _initLinks( $m, onClick, conf, horizontal )
	{
		...
		if ( horizontal )
		{
			var $submenu_element = $('.mm-is-menu'),
				$submenu_highlight = $('.mm-menu a.mm-subclose');
			...
			click( $('a.' + _c.subopen, $m),
				function()
				{
					...
					if ( $submenu )
					{
						...
						if (menu_level == 1) {
							$('.mm-menu a.mm-subclose').animate({ 
								backgroundColor: '#333333',
								borderBottomColor: '#1a1a1a'
							});
							$submenu_element.animate({ backgroundColor: '#252525' });
						}
						else if (menu_level == 2) {
							$('.mm-menu a.mm-subclose').animate({ backgroundColor: '#252525' });
							$submenu_element.animate({ backgroundColor: '#1a1a1a' });
						}
			...
			click( $('a.' + _c.subclose, $m),
				function()
				{
					...
					if (menu_level == 0) {
						...
						$submenu_element.animate({ backgroundColor: '#333333' });
					}
