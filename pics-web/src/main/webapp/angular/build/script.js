...
;
angular.module('PICS.employeeguard', ['ngRoute']).config([
  '$routeProvider',
  '$locationProvider',
  function ($routeProvider, $locationProvider) {
    $locationProvider.html5Mode(true);
    $routeProvider.when('/', { templateUrl: '/src/app/employeeguard/operator_employee/operator_employee.tpl.html' });
  }
]);
;
var test;
angular.module('PICS.employeeguard').controller('operatorEmployeeCtrl', [
  '$scope',
  '$http',
  '$filter',
...
;
angular.module('PICS.home', ['ngRoute']).config([
  '$routeProvider',
  function ($routeProvider) {
  }
]).controller('homeCtrl', [
...
;
angular.module('PICS.directives').directive('employeeskillsection', function () {
  return {
    restrict: 'E',
    scope: {
      title: '@',
...
;
angular.module('PICS.directives').directive('pagetitle', function () {
  return {
    restrict: 'E',
    scope: {
      title: '@title',
...
;
angular.module('PICS.directives').directive('skillstatusicon', function () {
  return {
    restrict: 'E',
    scope: { status: '@status' },
