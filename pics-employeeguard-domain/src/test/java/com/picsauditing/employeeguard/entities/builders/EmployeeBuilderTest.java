...
public class EmployeeBuilderTest {
    ...
    private void verifyGroups(Employee employee) {
        ...
        for (AccountGroupEmployee accountGroupEmployee : employee.getGroups()) {
            assertEquals(ACCOUNT_ID, accountGroupEmployee.getGroup().getAccountId());
            assertEquals(GROUPS.get(index), accountGroupEmployee.getGroup().getName());
            assertEquals(employee, accountGroupEmployee.getEmployee());
            index++;
        }
    }
}
