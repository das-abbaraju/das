...
public class ProfileDocumentBuilder extends AbstractBaseEntityBuilder<ProfileDocument, ProfileDocumentBuilder> {
	...
	public ProfileDocumentBuilder employeeSkills(List<AccountSkillProfile> employeeSkills) {
		entity.getProfileSkills().clear();
		entity.getProfileSkills().addAll(employeeSkills);
		return this;
	}
