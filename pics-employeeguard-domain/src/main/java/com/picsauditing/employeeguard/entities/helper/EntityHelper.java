...
public class EntityHelper {
	...
	public static <E extends BaseEntity> List<E> setCreateAuditFields(final List<E> entities, final EntityAuditInfo entityAuditInfo) {
		if (CollectionUtils.isEmpty(entities)) {
			return Collections.emptyList();
		}
	...
	public static <E extends BaseEntity> List<E> setUpdateAuditFields(final List<E> entities, final EntityAuditInfo entityAuditInfo) {
		if (CollectionUtils.isEmpty(entities)) {
			return Collections.emptyList();
		}

		for (E entity : entities) {
			setUpdateAuditFields(entities, entityAuditInfo);
		}
