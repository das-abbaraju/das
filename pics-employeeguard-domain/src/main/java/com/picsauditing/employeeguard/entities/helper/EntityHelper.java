...
public class EntityHelper {
	...
	public static <E extends BaseEntity> List<E> setCreateAuditFields(final List<E> entities,
																	  final EntityAuditInfo entityAuditInfo) {
		setCreateAuditFieldsForCollection(entities, entityAuditInfo);
	...
	private static <E extends BaseEntity> void setCreateAuditFieldsForCollection(final Collection<E> entities,
																				 final EntityAuditInfo entityAuditInfo) {
		if (CollectionUtils.isEmpty(entities)) {
			return;
		}
	...
	public static <E extends BaseEntity> List<E> setUpdateAuditFields(final List<E> entities,
																	  final EntityAuditInfo entityAuditInfo) {
		setUpdateAuditFieldsForCollection(entities, entityAuditInfo);
	...
	private static <E extends BaseEntity> void setUpdateAuditFieldsForCollection(final Collection<E> entities,
																				 final EntityAuditInfo entityAuditInfo) {
		if (CollectionUtils.isEmpty(entities)) {
			return;
		}
